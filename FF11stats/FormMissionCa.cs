...
namespace FF11stats
{
    public partial class FormMissionCa : Form
    {
        public FormMissionCa()
        {
            InitializeComponent();
            ...
            foreach( Control c in tableLayoutPanel1.Controls ) {
                if( c is CheckBox b ) {
                    if( cd.CampaignOps[int.Parse( b.Name.Substring( 2 ) )] != 0 ) {
                        l++;
                        b.Checked = true;
                    }
                }
        ...
        private void Apply()
        {
            foreach( Control c in tableLayoutPanel1.Controls ) {
                if( c is CheckBox b ) {
                    cd.CampaignOps[int.Parse( b.Name.Substring( 2 ) )] = Convert.ToSByte( b.Checked );
                }
            }
            return;
        }
