    ...
    public partial class FormItems : Form
    {
        ...
        internal FormItems( string kind )
        {
            ...
            case "toolStripMenuItem219":
                rd = new( ds.StorageSlip22 );
                Text = $"{mogSlip}【22】";
                break;
            case "toolStripMenuItem220":
                rd = new( ds.StorageSlip23 );
                Text = $"{mogSlip}【23】";
                break;
