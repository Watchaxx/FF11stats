...
#pragma warning disable IDE0051
        ...
        #endregion
        #region アイテム
        /// <summary>サルベージ，ナイズル，エインヘリヤル，アサルト</summary>
        ...
        /// <summary>免罪装備，トゥー・リア，ルモリア，リンバス，ユニティ</summary>
        ...
        /// <summary>花鳥風月，カンパニエ，VW，アビセア，エンブリオ，高級装束IL119</summary>
        ...
        internal Itm StorageSlip05 { get; } = new( 105 ) {   // 7-9
            ...
            { 11467, "COトリコルヌ+1" }, { 11294, "COフラック+1" }, { 15027, "COガントリー+1" }, { 16348, "COトルーズ+1" }, { 11384, "COブーツ+1" },
        ...
        internal Itm StorageSlip08 { get; } = new( 160 ) {   // 10-16
            ...
            { 12027, "サバントボネット" }, { 12047, "サバントガウン" }, { 12067, "サバントブレーサー" }, { 12087, "サバントパンツ" }, { 12107, "サバントローファー" }, { 11620, "サバントチェーン" }, { 19247, "サバントテーシス" },
        ...
        internal Itm StorageSlip11 { get; } = new( 192 ) {
            { 15297, "ラビットベルト" }, { 15298, "ワームベルト" }, { 15299, "マンドラゴラベルト" }, { 15919, "ドローバーベルト" },
            { 15929, "ゴブリンベルト" }, { 15921, "デトネーターベルト" }, { 18871, "キッティーロッド" }, { 16273, "チョコプラストルク" },
            { 18166, "ハッピーエッグ" }, { 18167, "ラッキーエッグ" }, { 18256, "オルペウスの卵" }, { 13216, "ゴールドモグベルト" },
            { 13217, "シルバーモグベルト" }, { 13218, "ブロンズモグベルト" }, { 15455, "レッドサッシュ" }, { 15456, "ダッシュサッシュ" },
            { 181, "王国旗" }, { 182, "共和国旗" }, { 183, "連邦旗" }, { 184, "大公国旗" },
            { 129, "皇国旗" }, { 11499, "トレイニーグラス" }, { 18502, "トレイニーアクス" }, { 18855, "トレイニーハンマー" },
            { 19274, "トレイニービュラン" }, { 18763, "トレイニーシザー" }, { 19110, "トレイニーニードル" }, { 15008, "トレイニーグローブ" },
            { 17764, "トレイニーソード" }, { 19101, "トレイニーナイフ" }, { 365, "ポワールクラシク" }, { 366, "カノーネンオフェン" },
            { 367, "ポットトッパー" }, { 15860, "玉兎の帯" }, { 272, "守護者HMの像" }, { 273, "守護者EVの像" },
            { 274, "守護者TTの像" }, { 275, "守護者MRの像" }, { 276, "守護者GKの像" }, { 11853, "ノベニアルコート" },
            { 11956, "ノベニアルホーズ" }, { 11854, "ノベニアルドレス" }, { 11957, "ノベニアルサイハイ" }, { 11811, "デストリアキャップ" },
            { 11812, "グラトスキャップ" }, { 11861, "彦神浴衣" }, { 11862, "姫神浴衣" }, { 3676, "星辰儀" },
            { 18879, "ラウンシーワンド" }, { 3647, "スプーキースワール" }, { 3648, "チョコグランプキン" }, { 3649, "ハーベストホラー" },
            { 3677, "スピネット" }, { 18880, "マエストロタクト" }, { 18863, "ドリームベル" }, { 18864, "ドリームベル+1" },
            { 15178, "ドリームキャップ" }, { 14519, "ドリームローブ" }, { 10382, "ドリームミトン" }, { 11965, "ドリームズボン" },
            { 11967, "ドリームパンツ" }, { 15752, "ドリームブーツ" }, { 15179, "ドリームキャップ+1" }, { 14520, "ドリームローブ+1" },
            { 10383, "ドリームミトン+1" }, { 11966, "ドリームズボン+1" }, { 11968, "ドリームパンツ+1" }, { 15753, "ドリームブーツ+1" },
            { 10875, "スノーマンキャップ" }, { 3619, "クーロヌエトワール" }, { 3620, "シルバークランツ" }, { 3621, "リーフベリーリース" },
            { 3650, "エッグステラ" }, { 3652, "メモリアルケーキ" }, { 10430, "デセニアルコロナ" }, { 10251, "デセニアルコート" },
            { 10593, "デセニアルタイツ" }, { 10431, "デセニアルバンド" }, { 10252, "デセニアルドレス" }, { 10594, "デセニアルホーズ" },
            { 10432, "デセニアルコロナ+1" }, { 10253, "デセニアルコート+1" }, { 10595, "デセニアルタイツ+1" }, { 10433, "デセニアルバンド+1" },
            { 10254, "デセニアルドレス+1" }, { 10596, "デセニアルホーズ+1" }, { 10429, "モグマスク" }, { 10250, "モグスーツ" },
            { 17031, "シェルセプター" }, { 17032, "ゴブリンガベル" }, { 10807, "マンドラガード" }, { 18881, "メロマーヌマレット" },
            { 10256, "マリンジレ" }, { 10330, "マリンボクサー" }, { 10257, "マリントップ" }, { 10331, "マリンショーツ" },
            { 10258, "ウッドジレ" }, { 10332, "ウッドボクサー" }, { 10259, "ウッドトップ" }, { 10333, "ウッドショーツ" },
            { 10260, "クリークマイヨー" }, { 10334, "クリークボクサー" }, { 10261, "クリークトップ" }, { 10335, "クリークショーツ" },
            { 10262, "リバートップ" }, { 10336, "リバーショーツ" }, { 10263, "デューンジレ" }, { 10337, "デューンボクサー" },
            { 10264, "マリンジレ+1" }, { 10338, "マリンボクサー+1" }, { 10265, "マリントップ+1" }, { 10339, "マリンショーツ+1" },
            { 10266, "ウッドジレ+1" }, { 10340, "ウッドボクサー+1" }, { 10267, "ウッドトップ+1" }, { 10341, "ウッドショーツ+1" },
            { 10268, "クリークマイヨー+1" }, { 10342, "クリークボクサー+1" }, { 10269, "クリークトップ+1" }, { 10343, "クリークショーツ+1" },
            { 10270, "リバートップ+1" }, { 10344, "リバーショーツ+1" }, { 10271, "デューンジレ+1" }, { 10345, "デューンボクサー+1" },
            { 10446, "アーリマンヘッド" }, { 10447, "ピュラクモンヘッド" }, { 426, "オーケストリオン" }, { 10808, "アケオメガード" },
            { 3654, "テンダーブーケ" }, { 265, "アダマンタスの像" }, { 266, "ベヒーモスの像" }, { 267, "ファヴニルの像" },
            { 269, "闇の王の像" }, { 270, "オーディンの像" }, { 271, "アレキサンダーの像" }, { 18464, "アークブレード" },
            { 18545, "アークタバール" }, { 18563, "アークサイズ" }, { 18912, "アークセイバー" }, { 18913, "アークソード" },
            { 10293, "チョコボシャツ" }, { 10809, "モーグリガード" }, { 10810, "モーグリガード+1" }, { 10811, "チョコシールド" },
            { 10812, "チョコシールド+1" }, { 27803, "ラステクマイヨー" }, { 28086, "ラステクトランク" }, { 27804, "ショールマイヨー" },
            { 28087, "ショールトランク" }, { 27805, "ラステクマイヨー+1" }, { 28088, "ラステクトランク+1" }, { 27806, "ショールマイヨー+1" },
            { 28089, "ショールトランク+1" }, { 27765, "チョコボマスク" }, { 27911, "チョコボスーツ" }, { 27760, "チョコボマスク+1" },
            { 27906, "チョコボスーツ+1" }, { 27759, "コリガンベレー" }, { 28661, "グリントシールド" }, { 286, "ナナー・ミーゴの像" },
            { 27757, "ボムマスク" }, { 27758, "ボムマスク+1" }, { 287, "ナナー・ミーゴ像II" }, { 27899, "アラインスシャツ" },
            { 28185, "アラインスパンツ" }, { 28324, "アラインスブーツ" }, { 27898, "アラインスシャツ+1" }, { 28655, "スライムシールド" },
            { 27756, "スライム帽子" }, { 28511, "スライムピアス" }, { 21118, "スプリガンクラブG" }, { 27902, "スプリガンコートG" },
            { 100, "大門松" }, { 21117, "羽子板" }, { 87, "門松" }, { 20953, "エスクリトリオ" },
            { 21280, "デカズームMK-XI" }, { 28652, "ハッチリンシールド" }, { 28650, "ベスシールド" }, { 27726, "ベス帽子" },
            { 28509, "ベスピアス" }, { 28651, "メタスラシールド" }, { 27727, "メタスラ帽子" }, { 28510, "メタスラピアス" },
            { 27872, "スプリガンコートP" }, { 21113, "スプリガンクラブP" }, { 27873, "スプリガンコートR" }, { 21114, "スプリガンクラブR" },
            { 20532, "ワームフィーラー" }, { 20533, "ワームフィーラー+1" }, { 27717, "ワームマスク" }, { 27718, "ワームマスク+1" }, };
        /// <summary>損壊したレリック</summary>
        internal Itm StorageSlip12 { get; } = new( 100 ) {  // 7-4
            { 2033, "WRマスク-1" }, { 2034, "WRロリカ-1" }, { 2035, "WRマフラ-1" }, { 2036, "WRクウィス-1" }, { 2037, "WRカリガ-1" },
            { 2038, "MLクラウン-1" }, { 2039, "MLシクラス-1" }, { 2040, "MLグローブ-1" }, { 2041, "MLホーズ-1" }, { 2042, "MLゲートル-1" },
            { 2043, "CRキャップ-1" }, { 2044, "CRブリオー-1" }, { 2045, "CRミトン-1" }, { 2046, "CRパンタロン-1" }, { 2047, "CRダックビル-1" },
            { 2048, "SRペタソス-1" }, { 2049, "SRコート-1" }, { 2050, "SRグローブ-1" }, { 2051, "SRトンバン-1" }, { 2052, "SRサボ-1" },
            { 2053, "DLシャポー-1" }, { 2054, "DLタバード-1" }, { 2055, "DLグローブ-1" }, { 2056, "DLタイツ-1" }, { 2057, "DLブーツ-1" },
            { 2058, "ASボンネット-1" }, { 2059, "ASベスト-1" }, { 2060, "ASアムレット-1" }, { 2061, "ASキュロット-1" }, { 2062, "ASプーレーヌ-1" },
            { 2063, "VLコロネット-1" }, { 2064, "VLサーコート-1" }, { 2065, "VLガントレ-1" }, { 2066, "VLブリーチズ-1" }, { 2067, "VLレギンス-1" },
            { 2068, "ABバーゴネット-1" }, { 2069, "ABキュイラス-1" }, { 2070, "ABガントレット-1" }, { 2071, "ABフランチャー-1" }, { 2072, "ABソルレット-1" },
            { 2073, "MSヘルム-1" }, { 2074, "MSジャック-1" }, { 2075, "MSグローブ-1" }, { 2076, "MSトラウザ-1" }, { 2077, "MSゲートル-1" },
            { 2078, "BDラウンドリト-1" }, { 2079, "BDジュストコル-1" }, { 2080, "BDカフス-1" }, { 2081, "BDキャニオンズ-1" }, { 2082, "BDスリッパー-1" },
            { 2083, "SCベレー-1" }, { 2084, "SCジャーキン-1" }, { 2085, "SCブレーサー-1" }, { 2086, "SCブラッカエ-1" }, { 2087, "SCソックス-1" },
            { 2088, "劣化早乙女桃形兜" }, { 2089, "劣化早乙女胴丸" }, { 2090, "劣化早乙女筒篭手" }, { 2091, "劣化早乙女板佩楯" }, { 2092, "劣化早乙女筒脛当" },
            { 2093, "劣化甲賀半首" }, { 2094, "劣化甲賀鎖帷子" }, { 2095, "劣化甲賀手甲" }, { 2096, "劣化甲賀袴" }, { 2097, "劣化甲賀脚絆" },
            { 2098, "WMアーメット-1" }, { 2099, "WMメイル-1" }, { 2100, "WMフィンガー-1" }, { 2101, "WMブレー-1" }, { 2102, "WMグリーヴ-1" },
            { 2103, "SMホーン-1" }, { 2104, "SMダブレット-1" }, { 2105, "SMブレーサー-1" }, { 2106, "SMスパッツ-1" }, { 2107, "SMピガッシュ-1" },
            { 2662, "MIケフィエ-1" }, { 2663, "MIジュバ-1" }, { 2664, "MIバズバンド-1" }, { 2665, "MIシャルワー-1" }, { 2666, "MIチャルク-1" },
            { 2667, "CMトリコルヌ-1" }, { 2668, "CMフラック-1" }, { 2669, "CMガントリー-1" }, { 2670, "CMトルーズ-1" }, { 2671, "CMブーツ-1" },
            { 2672, "PNタージ-1" }, { 2673, "PNトベ-1" }, { 2674, "PNダスタナ-1" }, { 2675, "PNチュリダル-1" }, { 2676, "PNバブーシュ-1" },
            { 2718, "ETティアラ-1" }, { 2719, "ETカザク-1" }, { 2720, "ETバングル-1" }, { 2721, "ETタイツ-1" }, { 2722, "ETトーシュー-1" },
            { 2723, "AGボード-1" }, { 2724, "AGガウン-1" }, { 2725, "AGブレーサー-1" }, { 2726, "AGパンツ-1" }, { 2727, "AGローファー-1" }, };
        /// <summary>レリック+2</summary>
        internal Itm StorageSlip13 { get; } = new( 100 ) {  // 7-4
            { 10650, "WRマスク+2" }, { 10670, "WRロリカ+2" }, { 10690, "WRマフラ+2" }, { 10710, "WRクウィス+2" }, { 10730, "WRカリガ+2" },
            { 10651, "MLクラウン+2" }, { 10671, "MLシクラス+2" }, { 10691, "MLグローブ+2" }, { 10711, "MLホーズ+2" }, { 10731, "MLゲートル+2" },
            { 10652, "CRキャップ+2" }, { 10672, "CRブリオー+2" }, { 10692, "CRミトン+2" }, { 10712, "CRパンタロン+2" }, { 10732, "CRダックビル+2" },
            { 10653, "SRペタソス+2" }, { 10673, "SRコート+2" }, { 10693, "SRグローブ+2" }, { 10713, "SRトンバン+2" }, { 10733, "SRサボ+2" },
            { 10654, "DLシャポー+2" }, { 10674, "DLタバード+2" }, { 10694, "DLグローブ+2" }, { 10714, "DLタイツ+2" }, { 10734, "DLブーツ+2" },
            { 10655, "ASボンネット+2" }, { 10675, "ASベスト+2" }, { 10695, "ASアムレット+2" }, { 10715, "ASキュロット+2" }, { 10735, "ASプーレーヌ+2" },
            { 10656, "VLコロネット+2" }, { 10676, "VLサーコート+2" }, { 10696, "VLガントレ+2" }, { 10716, "VLブリーチズ+2" }, { 10736, "VLレギンス+2" },
            { 10657, "ABバーゴネット+2" }, { 10677, "ABキュイラス+2" }, { 10697, "ABガントレット+2" }, { 10717, "ABフランチャー+2" }, { 10737, "ABソルレット+2" },
            { 10658, "MSヘルム+2" }, { 10678, "MSジャック+2" }, { 10698, "MSグローブ+2" }, { 10718, "MSトラウザ+2" }, { 10738, "MSゲートル+2" },
            { 10659, "BDラウンドリト+2" }, { 10679, "BDジュストコル+2" }, { 10699, "BDカフス+2" }, { 10719, "BDキャニオンズ+2" }, { 10739, "BDスリッパー+2" },
            { 10660, "SCベレー+2" }, { 10680, "SCジャーキン+2" }, { 10700, "SCブレーサー+2" }, { 10720, "SCブラッカエ+2" }, { 10740, "SCソックス+2" },
            { 10661, "真早乙女桃形兜" }, { 10681, "真早乙女胴丸" }, { 10701, "真早乙女筒篭手" }, { 10721, "真早乙女板佩楯" }, { 10741, "真早乙女筒脛当" },
            { 10662, "真甲賀半首" }, { 10682, "真甲賀鎖帷子" }, { 10702, "真甲賀手甲" }, { 10722, "真甲賀袴" }, { 10742, "真甲賀脚絆" },
            { 10663, "WMアーメット+2" }, { 10683, "WMメイル+2" }, { 10703, "WMフィンガー+2" }, { 10723, "WMブレー+2" }, { 10743, "WMグリーヴ+2" },
            { 10664, "SMホーン+2" }, { 10684, "SMダブレット+2" }, { 10704, "SMブレーサー+2" }, { 10724, "SMスパッツ+2" }, { 10744, "SMピガッシュ+2" },
            { 10665, "MIケフィエ+2" }, { 10685, "MIジュバ+2" }, { 10705, "MIバズバンド+2" }, { 10725, "MIシャルワー+2" }, { 10745, "MIチャルク+2" },
            { 10666, "CMトリコルヌ+2" }, { 10686, "CMフラック+2" }, { 10706, "CMガントリー+2" }, { 10726, "CMトルーズ+2" }, { 10746, "CMブーツ+2" },
            { 10667, "PNタージ+2" }, { 10687, "PNトベ+2" }, { 10707, "PNダスタナ+2" }, { 10727, "PNチュリダル+2" }, { 10747, "PNバブーシュ+2" },
            { 10668, "ETティアラ+2" }, { 10688, "ETカザク+2" }, { 10708, "ETバングル+2" }, { 10728, "ETタイツ+2" }, { 10748, "ETトーシュー+2" },
            { 10669, "AGボード+2" }, { 10689, "AGガウン+2" }, { 10709, "AGブレーサー+2" }, { 10729, "AGパンツ+2" }, { 10749, "AGローファー+2" } };
        /// <summary>サルベージ2，ナイズル2，エインヘリヤル2，ドメインベージョン</summary>
        internal Itm StorageSlip14 { get; } = new( 125 ) {  // 8-13
            { 10901, "ポルキスサラド" }, { 10474, "ポルキスコラジン" }, { 10523, "ポルキスマノポラ" }, { 10554, "ポルキスディル" }, { 10620, "ポルキスシュー" },
            { 10906, "タウマスハット" }, { 10479, "タウマスコート" }, { 10528, "タウマスリスト" }, { 10559, "タウマスケックス" }, { 10625, "タウマスネール" },
            { 10911, "ナレスシャポー" }, { 10484, "ナレスサイオ" }, { 10533, "ナレスカフス" }, { 10564, "ナレストルーズ" }, { 10630, "ナレスクロッグ" },
            { 19799, "ヘルヤフォーク" }, { 18916, "ヘイムダルドゥーム" }, { 10442, "レイラドルヘルム" }, { 10280, "レイラドルブレスト" },
            { 27648, "ARマスク+1" }, { 27788, "ARキュイラス+1" }, { 27928, "ARガントレット+1" }, { 28071, "ARフランチャー+1" }, { 28208, "ARソルレット+1" },
            { 27649, "SKバイザー+1" }, { 27789, "SKクウィリ+1" }, { 27929, "SKバズバンド+1" }, { 28072, "SKショウス+1" }, { 28209, "SKジャンボー+1" },
            { 27650, "薄金総面改" }, { 27790, "薄金腹巻改" }, { 27930, "薄金篭手改" }, { 28073, "薄金膝甲改" }, { 28210, "薄金脛当改" },
            { 27651, "MKティアラ+1" }, { 27791, "MKジュバ+1" }, { 27931, "MKダスタナ+1" }, { 28074, "MKシャルワ+1" }, { 28211, "MKクラッコ+1" },
            { 27652, "MOコロナル+1" }, { 27792, "MOローブ+1" }, { 27932, "MOカフス+1" }, { 28075, "MOスロップス+1" }, { 28212, "MOピガッシュ+1" },
            { 27653, "ケールマスク" }, { 27793, "ケールキュイラス" }, { 27933, "ケールガントレット" }, { 28076, "ケールフランチャー" }, { 28213, "ケールソルレット" },
            { 27654, "シギュンバイザー" }, { 27794, "シギュンクウィリ" }, { 27934, "シギュンバズバンド" }, { 28077, "シギュンショウス" }, { 28214, "シギュンジャンボー" },
            { 27655, "沢瀉総面" }, { 27795, "沢瀉腹巻" }, { 27935, "沢瀉篭手" }, { 28078, "沢瀉膝甲" }, { 28215, "沢瀉脛当" },
            { 27656, "ナブーティアラ" }, { 27796, "ナブージュバ" }, { 27936, "ナブーダスタナ" }, { 28079, "ナブーシャルワ" }, { 28216, "ナブークラッコ" },
            { 27657, "フェアコロナル" }, { 27797, "フェアローブ" }, { 27937, "フェアカフス" }, { 28080, "フェアスロップス" }, { 28217, "フェアピガッシュ" },
            { 27658, "アテーマスク" }, { 27798, "アテーキュイラス" }, { 27938, "アテーガントレット" }, { 28081, "アテーフランチャー" }, { 28218, "アテーソルレット" },
            { 27659, "イジマスク" }, { 27799, "イジジャーキン" }, { 27939, "イジグローブ" }, { 28082, "イジトラウザ" }, { 28219, "イジレデルセン" },
            { 27660, "源太兜" }, { 27800, "源太腹当" }, { 27940, "源太篭手" }, { 28083, "源太の袴" }, { 28220, "源太脛当" },
            { 27661, "ナムルーティアラ" }, { 27801, "ナムルージュバ" }, { 27941, "ナムルーダスタナ" }, { 28084, "ナムルーシャルワ" }, { 28221, "ナムルークラッコ" },
            { 27662, "ネイトクラウン" }, { 27802, "ネイトコート" }, { 27942, "ネイトカフス" }, { 28085, "ネイトスロップス" }, { 28222, "ネイトピガッシュ" },
            { 21510, "ボルスパナックル" }, { 21566, "ボルスパナイフ" }, { 21622, "ボルスパソード" }, { 21665, "ボルスパブレード" },
            { 21712, "ボルスパピック" }, { 21769, "ボルスパチョッパー" }, { 21822, "ボルスパサイズ" }, { 21864, "ボルスパランス" },
            { 21912, "ボルスパカタナ" }, { 21976, "ボルスパタチ" }, { 22006, "ボルスパハンマー" }, { 22088, "ボルスパポール" },
            { 22133, "ボルスパボウ" }, { 22144, "ボルスパガン" }, { 22219, "ボルスパグリップ" }, { 26413, "ボルスパシールド" },
            { 23738, "ヘルボルガレア" }, { 23741, "ヘルボルオーベール" }, { 23744, "ヘルボルムフル" }, { 23747, "ヘルボルブエレット" }, { 23750, "ヘルボルソルレット" },
            { 23739, "ハイドレマスク" }, { 23742, "ハイドレハーネス" }, { 23745, "ハイドレグローブ" }, { 23748, "ハイドレブレー" }, { 23751, "ハイドレブーツ" },
            { 23740, "アンガティルベレー" }, { 23743, "アンガティルローブ" }, { 23746, "アンガティルミトン" }, { 23749, "アンガティルタイツ" }, { 23752, "アンガティルブーツ" }, };
        /// <summary>AF109</summary>
        internal Itm StorageSlip15 { get; } = new( 105 ) {  // 7-9
            { 27663, "パメラーマスク" }, { 27807, "パメラーロリカ" }, { 27943, "パメラーマフラ" }, { 28090, "パメラークウィス" }, { 28223, "パメラーカリガ" },
            { 27664, "アンコリトクラウン" }, { 27808, "アンコリトシクラス" }, { 27944, "アンコリトグローブ" }, { 28091, "アンコリトホーズ" }, { 28224, "アンコリトゲートル" },
            { 27665, "セオフニキャップ" }, { 27809, "セオフニブリオー" }, { 27945, "セオフニミトン" }, { 28092, "セオフニパンタロン" }, { 28225, "セオフニダックビル" },
            { 27666, "スピコナペタソス" }, { 27810, "スピコナコート" }, { 27946, "スピコナグローブ" }, { 28093, "スピコナトンバン" }, { 28226, "スピコナサボ" },
            { 27667, "アトロピシャポー" }, { 27811, "アトロピタバード" }, { 27947, "アトロピグローブ" }, { 28094, "アトロピタイツ" }, { 28227, "アトロピブーツ" },
            { 27668, "ピレジャボンネット" }, { 27812, "ピレジャベスト" }, { 27948, "ピレジャアムレット" }, { 28095, "ピレジャキュロット" }, { 28228, "ピレジャプーレーヌ" },
            { 27669, "レベランコロネット" }, { 27813, "レベランサーコート" }, { 27949, "レベランガントレ" }, { 28096, "レベランブリーチズ" }, { 28229, "レベランレギンス" },
            { 27670, "イグニムバゴネット" }, { 27814, "イグニムキュイラス" }, { 27950, "イグニムガントレ" }, { 28097, "イグニムフランチャ" }, { 28230, "イグニムソルレット" },
            { 27671, "トテミクヘルム" }, { 27815, "トテミクジャック" }, { 27951, "トテミクグローブ" }, { 28098, "トテミクトラウザ" }, { 28231, "トテミクゲートル" },
            { 27672, "ブリオソランドリト" }, { 27816, "ブリオソジュスト" }, { 27952, "ブリオソカフス" }, { 28099, "ブリオソキャニオン" }, { 28232, "ブリオソスリッパー" },
            { 27673, "オリオンベレー" }, { 27817, "オリオンジャーキン" }, { 27953, "オリオンブレーサー" }, { 28100, "オリオンブラッカエ" }, { 28233, "オリオンソックス" },
            { 27674, "脇戸桃形兜" }, { 27818, "脇戸胴丸" }, { 27954, "脇戸筒篭手" }, { 28101, "脇戸板佩楯" }, { 28234, "脇戸筒脛当" },
            { 27675, "蜂屋半首" }, { 27819, "蜂屋鎖帷子" }, { 27955, "蜂屋手甲" }, { 28102, "蜂屋袴" }, { 28235, "蜂屋脚絆" },
            { 27676, "ビシャプアーメット" }, { 27820, "ビシャプメイル" }, { 27956, "ビシャプフィンガー" }, { 28103, "ビシャプブレー" }, { 28236, "ビシャプグリーヴ" },
            { 27677, "コンボカホーン" }, { 27821, "コンボカダブレット" }, { 27957, "コンボカブレーサー" }, { 28104, "コンボカスパッツ" }, { 28237, "コンボカピガッシュ" },
            { 27678, "アシムレケフィエ" }, { 27822, "アシムレジュバ" }, { 27958, "アシムレバズバンド" }, { 28105, "アシムレシャルワー" }, { 28238, "アシムレチャルク" },
            { 27679, "ラクサマトリコルヌ" }, { 27823, "ラクサマフラック" }, { 27959, "ラクサマガントリー" }, { 28106, "ラクサマトルーズ" }, { 28239, "ラクサマブーツ" },
            { 27680, "フォワルタージ" }, { 27824, "フォワルトベ" }, { 27960, "フォワルダスタナ" }, { 28107, "フォワルチュリダル" }, { 28240, "フォワルバブーシュ" },
            { 27681, "マシシティアラ♂" }, { 27825, "マシシカザク♂" }, { 27961, "マシシバングル♂" }, { 28108, "マシシタイツ♂" }, { 28241, "マシシトーシュー♂" },
            { 27682, "マシシティアラ♀" }, { 27826, "マシシカザク♀" }, { 27962, "マシシバングル♀" }, { 28109, "マシシタイツ♀" }, { 28242, "マシシトーシュー♀" },
            { 27683, "アカデミボード" }, { 27827, "アカデミガウン" }, { 27963, "アカデミブレーサー" }, { 28110, "アカデミパンツ" }, { 28243, "アカデミローファー" } };
        /// <summary>AF119</summary>
        internal Itm StorageSlip16 { get; } = new( 115 ) {  // 8-3
            { 27684, "PMマスク+1" }, { 27828, "PMロリカ+1" }, { 27964, "PMマフラ+1" }, { 28111, "PMクウィス+1" }, { 28244, "PMカリガ+1" },
            { 27685, "ANクラウン+1" }, { 27829, "ANシクラス+1" }, { 27965, "ANグローブ+1" }, { 28112, "ANホーズ+1" }, { 28245, "ANゲートル+1" },
            { 27686, "TEキャップ+1" }, { 27830, "TEブリオー+1" }, { 27966, "TEミトン+1" }, { 28113, "TEパンタロン+1" }, { 28246, "TEダックビル+1" },
            { 27687, "SPペタソス+1" }, { 27831, "SPコート+1" }, { 27967, "SPグローブ+1" }, { 28114, "SPトンバン+1" }, { 28247, "SPサボ+1" },
            { 27688, "ATシャポー+1" }, { 27832, "ATタバード+1" }, { 27968, "ATグローブ+1" }, { 28115, "ATタイツ+1" }, { 28248, "ATブーツ+1" },
            { 27689, "PLボンネット+1" }, { 27833, "PLベスト+1" }, { 27969, "PLアムレット+1" }, { 28116, "PLキュロット+1" }, { 28249, "PLプーレーヌ+1" },
            { 27690, "RVコロネット+1" }, { 27834, "RVサーコート+1" }, { 27970, "RVガントレ+1" }, { 28117, "RVブリーチズ+1" }, { 28250, "RVレギンス+1" },
            { 27691, "IGバゴネット+1" }, { 27835, "IGキュイラス+1" }, { 27971, "IGガントレ+1" }, { 28118, "IGフランチャ+1" }, { 28251, "IGソルレット+1" },
            { 27692, "TOヘルム+1" }, { 27836, "TOジャック+1" }, { 27972, "TOグローブ+1" }, { 28119, "TOトラウザ+1" }, { 28252, "TOゲートル+1" },
            { 27693, "BRランドリト+1" }, { 27837, "BRジュスト+1" }, { 27973, "BRカフス+1" }, { 28120, "BRキャニオン+1" }, { 28253, "BRスリッパー+1" },
            { 27694, "ORベレー+1" }, { 27838, "ORジャーキン+1" }, { 27974, "ORブレーサー+1" }, { 28121, "ORブラッカエ+1" }, { 28254, "ORソックス+1" },
            { 27695, "脇戸桃形兜改" }, { 27839, "脇戸胴丸改" }, { 27975, "脇戸筒篭手改" }, { 28122, "脇戸板佩楯改" }, { 28255, "脇戸筒脛当改" },
            { 27696, "蜂屋半首改" }, { 27840, "蜂屋鎖帷子改" }, { 27976, "蜂屋手甲改" }, { 28123, "蜂屋袴改" }, { 28256, "蜂屋脚絆改" },
            { 27697, "VSアーメット+1" }, { 27841, "VSメイル+1" }, { 27977, "VSフィンガー+1" }, { 28124, "VSブレー+1" }, { 28257, "VSグリーヴ+1" },
            { 27698, "CNホーン+1" }, { 27842, "CNダブレット+1" }, { 27978, "CNブレーサー+1" }, { 28125, "CNスパッツ+1" }, { 28258, "CNピガッシュ+1" },
            { 27699, "ASケフィエ+1" }, { 27843, "ASジュバ+1" }, { 27979, "ASバズバンド+1" }, { 28126, "ASシャルワー+1" }, { 28259, "ASチャルク+1" },
            { 27700, "LKトリコルヌ+1" }, { 27844, "LKフラック+1" }, { 27980, "LKガントリー+1" }, { 28127, "LKトルーズ+1" }, { 28260, "LKブーツ+1" },
            { 27701, "FOタージ+1" }, { 27845, "FOトベ+1" }, { 27981, "FOダスタナ+1" }, { 28128, "FOチュリダル+1" }, { 28261, "FOバブーシュ+1" },
            { 27702, "MXティアラ+1♂" }, { 27846, "MXカザク+1♂" }, { 27982, "MXバングル+1♂" }, { 28129, "MXタイツ+1♂" }, { 28262, "MXトーシュー+1♂" },
            { 27703, "MXティアラ+1♀" }, { 27847, "MXカザク+1♀" }, { 27983, "MXバングル+1♀" }, { 28130, "MXタイツ+1♀" }, { 28263, "MXトーシュー+1♀" },
            { 27704, "ACボード+1" }, { 27848, "ACガウン+1" }, { 27984, "ACブレーサー+1" }, { 28131, "ACパンツ+1" }, { 28264, "ACローファー+1" },
            { 27705, "GOガレーロ+1" }, { 27849, "GOチュニック+1" }, { 27985, "GOミテーヌ+1" }, { 28132, "GOパンツ+1" }, { 28265, "GOサンダル+1" },
            { 27706, "RNバンド+1" }, { 27850, "RNコート+1" }, { 27986, "RNミトン+1" }, { 28133, "RNトラウザ+1" }, { 28266, "RNブーツ+1" } };
        /// <summary>レリック109</summary>
        internal Itm StorageSlip17 { get; } = new( 110 ) {  // 7-14
            { 26624, "アゴージマスク" }, { 26800, "アゴージロリカ" }, { 26976, "アゴージマフラ" }, { 27152, "アゴージクウィス" }, { 27328, "アゴージカリガ" },
            { 26626, "ヘシカスクラウン" }, { 26802, "ヘシカスシクラス" }, { 26978, "ヘシカスグローブ" }, { 27154, "ヘシカスホーズ" }, { 27330, "ヘシカスゲートル" },
            { 26628, "パエティキャップ" }, { 26804, "パエティブリオー" }, { 26980, "パエティミトン" }, { 27156, "パエティパンタロン" }, { 27332, "パエティダックビル" },
            { 26630, "アークペタソス" }, { 26806, "アークコート" }, { 26982, "アークグローブ" }, { 27158, "アークトンバン" }, { 27334, "アークサボ" },
            { 26632, "ヴィティシャポー" }, { 26808, "ヴィティタバード" }, { 26984, "ヴィティグローブ" }, { 27160, "ヴィティタイツ" }, { 27336, "ヴィティブーツ" },
            { 26634, "プランダボンネット" }, { 26810, "プランダベスト" }, { 26986, "プランダアムレット" }, { 27162, "プランダキュロット" }, { 27338, "プランダプーレーヌ" },
            { 26636, "カバラリコロネット" }, { 26812, "カバラリサーコート" }, { 26988, "カバラリガントレ" }, { 27164, "カバラリブリーチズ" }, { 27340, "カバラリレギンス" },
            { 26638, "ファレバーゴネット" }, { 26814, "ファレキュイラス" }, { 26990, "ファレガントレット" }, { 27166, "ファレフランチャー" }, { 27342, "ファレソルレット" },
            { 26640, "アンクサヘルム" }, { 26816, "アンクサジャック" }, { 26992, "アンクサグローブ" }, { 27168, "アンクサトラウザ" }, { 27344, "アンクサゲートル" },
            { 26642, "ビフラウンドリト" }, { 26818, "ビフジュストコル" }, { 26994, "ビフカフス" }, { 27170, "ビフキャニオンズ" }, { 27346, "ビフスリッパー" },
            { 26644, "アルケベレー" }, { 26820, "アルケジャーキン" }, { 26996, "アルケブレーサー" }, { 27172, "アルケブラッカエ" }, { 27348, "アルケソックス" },
            { 26646, "左近士桃形兜" }, { 26822, "左近士胴丸" }, { 26998, "左近士筒篭手" }, { 27174, "左近士板佩楯" }, { 27350, "左近士筒脛当" },
            { 26648, "望月半首" }, { 26824, "望月鎖帷子" }, { 27000, "望月手甲" }, { 27176, "望月袴" }, { 27352, "望月脚絆" },
            { 26650, "テロスレアーメット" }, { 26826, "テロスレメイル" }, { 27002, "テロスレフィンガー" }, { 27178, "テロスレブレー" }, { 27354, "テロスレグリーヴ" },
            { 26652, "グリフホーン" }, { 26828, "グリフダブレット" }, { 27004, "グリフブレーサー" }, { 27180, "グリフスパッツ" }, { 27356, "グリフピガッシュ" },
            { 26654, "ルラーザケフィエ" }, { 26830, "ルラーザジュバ" }, { 27006, "ルラーザバズバンド" }, { 27182, "ルラーザシャルワー" }, { 27358, "ルラーザチャルク" },
            { 26656, "ラヌントリコルヌ" }, { 26832, "ラヌンフラック" }, { 27008, "ラヌンガントリー" }, { 27184, "ラヌントルーズ" }, { 27360, "ラヌンブーツ" },
            { 26658, "ピトルタージ" }, { 26834, "ピトルトベ" }, { 27010, "ピトルダスタナ" }, { 27186, "ピトルチュリダル" }, { 27362, "ピトルバブーシュ" },
            { 26660, "ホロスティアラ" }, { 26836, "ホロスカザク" }, { 27012, "ホロスバングル" }, { 27188, "ホロスタイツ" }, { 27364, "ホロストーシュー" },
            { 26662, "ペダゴギボード" }, { 26838, "ペダゴギガウン" }, { 27014, "ペダゴギブレーサー" }, { 27190, "ペダゴギパンツ" }, { 27366, "ペダゴギローファー" },
            { 26664, "バグアガレーロ" }, { 26840, "バグアチュニック" }, { 27016, "バグアミテーヌ" }, { 27192, "バグアパンツ" }, { 27368, "バグアサンダル" },
            { 26666, "フサルクバンド" }, { 26842, "フサルクコート" }, { 27018, "フサルクミトン" }, { 27194, "フサルクトラウザ" }, { 27370, "フサルクブーツ" } };
        /// <summary>レリック119</summary>
        internal Itm StorageSlip18 { get; } = new( 110 ) {  // 7-14
            { 26625, "AGマスク+1" }, { 26801, "AGロリカ+1" }, { 26977, "AGマフラ+1" }, { 27153, "AGクウィス+1" }, { 27329, "AGカリガ+1" },
            { 26627, "HEクラウン+1" }, { 26803, "HEシクラス+1" }, { 26979, "HEグローブ+1" }, { 27155, "HEホーズ+1" }, { 27331, "HEゲートル+1" },
            { 26629, "PIキャップ+1" }, { 26805, "PIブリオー+1" }, { 26981, "PIミトン+1" }, { 27157, "PIパンタロン+1" }, { 27333, "PIダックビル+1" },
            { 26631, "ARペタソス+1" }, { 26807, "ARコート+1" }, { 26983, "ARグローブ+1" }, { 27159, "ARトンバン+1" }, { 27335, "ARサボ+1" },
            { 26633, "VIシャポー+1" }, { 26809, "VIタバード+1" }, { 26985, "VIグローブ+1" }, { 27161, "VIタイツ+1" }, { 27337, "VIブーツ+1" },
            { 26635, "PDボンネット+1" }, { 26811, "PDベスト+1" }, { 26987, "PDアムレット+1" }, { 27163, "PDキュロット+1" }, { 27339, "PDプーレーヌ+1" },
            { 26637, "CBコロネット+1" }, { 26813, "CBサーコート+1" }, { 26989, "CBガントレ+1" }, { 27165, "CBブリーチズ+1" }, { 27341, "CBレギンス+1" },
            { 26639, "FLバーゴネット+1" }, { 26815, "FLキュイラス+1" }, { 26991, "FLガントレット+1" }, { 27167, "FLフランチャー+1" }, { 27343, "FLソルレット+1" },
            { 26641, "AKヘルム+1" }, { 26817, "AKジャック+1" }, { 26993, "AKグローブ+1" }, { 27169, "AKトラウザ+1" }, { 27345, "AKゲートル+1" },
            { 26643, "BIラウンドリト+1" }, { 26819, "BIジュストコル+1" }, { 26995, "BIカフス+1" }, { 27171, "BIキャニオンズ+1" }, { 27347, "BIスリッパー+1" },
            { 26645, "ARベレー+1" }, { 26821, "ARジャーキン+1" }, { 26997, "ARブレーサー+1" }, { 27173, "ARブラッカエ+1" }, { 27349, "ARソックス+1" },
            { 26647, "左近士桃形兜改" }, { 26823, "左近士胴丸改" }, { 26999, "左近士筒篭手改" }, { 27175, "左近士板佩楯改" }, { 27351, "左近士筒脛当改" },
            { 26649, "望月半首改" }, { 26825, "望月鎖帷子改" }, { 27001, "望月手甲改" }, { 27177, "望月袴改" }, { 27353, "望月脚絆改" },
            { 26651, "PTアーメット+1" }, { 26827, "PTメイル+1" }, { 27003, "PTフィンガー+1" }, { 27179, "PTブレー+1" }, { 27355, "PTグリーヴ+1" },
            { 26653, "GLホーン+1" }, { 26829, "GLダブレット+1" }, { 27005, "GLブレーサー+1" }, { 27181, "GLスパッツ+1" }, { 27357, "GLピガッシュ+1" },
            { 26655, "LLケフィエ+1" }, { 26831, "LLジュバ+1" }, { 27007, "LLバズバンド+1" }, { 27183, "LLシャルワー+1" }, { 27359, "LLチャルク+1" },
            { 26657, "LAトリコルヌ+1" }, { 26833, "LAフラック+1" }, { 27009, "LAガントリー+1" }, { 27185, "LAトルーズ+1" }, { 27361, "LAブーツ+1" },
            { 26659, "PIタージ+1" }, { 26835, "PIトベ+1" }, { 27011, "PIダスタナ+1" }, { 27187, "PIチュリダル+1" }, { 27363, "PIバブーシュ+1" },
            { 26661, "HOティアラ+1" }, { 26837, "HOカザク+1" }, { 27013, "HOバングル+1" }, { 27189, "HOタイツ+1" }, { 27365, "HOトーシュー+1" },
            { 26663, "PDボード+1" }, { 26839, "PDガウン+1" }, { 27015, "PDブレーサー+1" }, { 27191, "PDパンツ+1" }, { 27367, "PDローファー+1" },
            { 26665, "BAガレーロ+1" }, { 26841, "BAチュニック+1" }, { 27017, "BAミテーヌ+1" }, { 27193, "BAパンツ+1" }, { 27369, "BAサンダル+1" },
            { 26667, "FUバンド+1" }, { 26843, "FUコート+1" }, { 27019, "FUミトン+1" }, { 27195, "FUトラウザ+1" }, { 27371, "FUブーツ+1" }, };
        /// <summary>イベント報酬2</summary>
        internal Itm StorageSlip19 { get; } = new( 192 ) {
            { 27715, "ゴブマスク" }, { 27866, "ゴブスーツ" }, { 27716, "グリーンモグマスク" }, { 27867, "グリーンモグスーツ" },
            { 278, "カーディアンの像" }, { 281, "アトモスの像" }, { 284, "グゥーブーの像" }, { 3680, "審判の日" },
            { 3681, "アルザダールデスク" }, { 27859, "牽牛法被" }, { 28149, "牽牛半股引" }, { 27860, "織女法被" },
            { 28150, "織女半股引" }, { 21107, "九夏団扇" }, { 21108, "九夏団扇+1" }, { 27625, "モルボルシールド" },
            { 27626, "キャシーシールド" }, { 26693, "モルボルキャップ" }, { 26694, "キャシーキャップ" }, { 26707, "フランマスク" },
            { 26708, "フランマスク+1" }, { 27631, "ケットガード" }, { 27632, "ケットガード+1" }, { 26705, "マンドラマスク" },
            { 26706, "マンドラマスク+1" }, { 27854, "マンドラスーツ" }, { 27855, "マンドラスーツ+1" }, { 26703, "リコポンマスク" },
            { 26704, "リコポンマスク+1" }, { 3682, "双葉の音楽家" }, { 3683, "森の住人" }, { 3684, "若姫の微笑" },
            { 3685, "第16代聖皇" }, { 3686, "天真爛漫" }, { 3687, "結晶の守り人" }, { 3688, "トップダンサー" },
            { 3689, "連邦の黒い悪魔" }, { 3690, "東の武士" }, { 3691, "隻眼の女将軍" }, { 3692, "銃士紅一点" },
            { 3693, "子羊の像" }, { 3694, "子羊の像II" }, { 3695, "招き猫" }, { 21097, "リフキンバッパー" },
            { 21098, "リフキンバッパー+1" }, { 26717, "ケットキャップ" }, { 26718, "ケットキャップ+1" }, { 26728, "フロスティキャップ" },
            { 26719, "シープキャップ" }, { 26720, "シープキャップ+1" }, { 26889, "ハートエプロン" }, { 26890, "ハートエプロン+1" },
            { 21095, "ハートビーター" }, { 21096, "ハートビーター+1" }, { 26738, "リフキンキャップ" }, { 26739, "リフキンキャップ+1" },
            { 26729, "コローラ" }, { 26730, "セレストキャップ" }, { 26788, "ラビットキャップ" }, { 26946, "ピュピルシャツ" },
            { 27281, "ピュピルトラウザ" }, { 27455, "ピュピルシューズ" }, { 26789, "尚武鳳凰兜" }, { 3698, "桜" },
            { 20713, "エクスカリパー" }, { 20714, "エクスカリパーII" }, { 26798, "ベヒーモスマスク" }, { 26954, "ベヒーモススーツ" },
            { 26799, "ベヒーモスマスク+1" }, { 26955, "ベヒーモススーツ+1" }, { 3706, "ヴァナクロック" }, { 26956, "ポロッゴコート" },
            { 26957, "ポロッゴコート+1" }, { 3705, "囲炉裏" }, { 26964, "ピュピルカミーサ" }, { 26965, "タ・モコ" },
            { 27291, "スイミングトグス" }, { 26967, "コシートップ" }, { 27293, "コシーボトム" }, { 26966, "タ・モコ+1" },
            { 27292, "スイミングトグス+1" }, { 26968, "コシートップ+1" }, { 27294, "コシーボトム+1" }, { 21153, "マリスマッシャー" },
            { 21154, "マリスマッシャー+1" }, { 21086, "ハートストッパー" }, { 21087, "ハートストッパー+1" }, { 25606, "エージェントフード" },
            { 26974, "エージェントコート" }, { 27111, "エージェントカフス" }, { 27296, "エージェントパンツ" }, { 27467, "エージェントブーツ" },
            { 25607, "スターレトフラワー" }, { 26975, "スターレトジャボ" }, { 27112, "スターレトグローブ" }, { 27297, "スターレトスカート" },
            { 27468, "スターレトブーツ" }, { 14195, "ウエーダー" }, { 14830, "木工軍手" }, { 14831, "耐熱ミトン" },
            { 13945, "遮光眼鏡" }, { 13946, "拡大眼鏡" }, { 14832, "革工手袋" }, { 13947, "防塵眼鏡" },
            { 17058, "カドゥケウス" }, { 13948, "衛生帽子" }, { 14400, "漁師エプロン" }, { 14392, "木彫師エプロン" },
            { 14393, "鍛冶師エプロン" }, { 14394, "彫金師エプロン" }, { 14395, "裁縫師エプロン" }, { 14396, "革細工師エプロン" },
            { 14397, "骨彫師エプロン" }, { 14398, "錬金術師エプロン" }, { 14399, "調理師エプロン" }, { 11337, "漁師スモック" },
            { 11329, "木彫師スモック" }, { 11330, "鍛冶師スモック" }, { 11331, "彫金師スモック" }, { 11332, "裁縫師スモック" },
            { 11333, "革細工師スモック" }, { 11334, "骨彫師スモック" }, { 11335, "錬金術師スモック" }, { 11336, "調理師スモック" },
            { 15819, "初志の指輪：木工" }, { 15820, "初志の指輪：鍛冶" }, { 15821, "初志の指輪：彫金" }, { 15822, "初志の指輪：裁縫" },
            { 15823, "初志の指輪：革工" }, { 15824, "初志の指輪：骨工" }, { 15825, "初志の指輪：錬金術" }, { 15826, "初志の指輪：調理" },
            { 3670, "魚網セット" }, { 3672, "カーペンターキット" }, { 3661, "ストーンハース" }, { 3595, "ジェムスコープ" },
            { 3665, "スピニングホイール" }, { 3668, "ハイドストレッチャ" }, { 3663, "骨細工セット" }, { 3674, "アレンビック" },
            { 3667, "シチューポット" }, { 191, "ポイント地図" }, { 28, "ドローイングデスク" }, { 153, "マイスターアンビル" },
            { 151, "愚者の黄金" }, { 198, "錦のタピストリー" }, { 202, "黄金の羊の毛皮" }, { 142, "ドロガロガの牙" },
            { 134, "エメラルド写本" }, { 137, "コルドンブルー包丁" }, { 340, "漁師サインボード" }, { 341, "木工サインボード" },
            { 334, "鍛冶師サインボード" }, { 335, "彫金師サインボード" }, { 337, "織工サインボード" }, { 339, "革工サインボード" },
            { 336, "骨工サインボード" }, { 342, "錬金術サインボード" }, { 338, "調理師サインボード" }, { 3631, "漁師カウンター" },
            { 3632, "木工カウンター" }, { 3625, "鍛冶カウンター" }, { 3626, "彫金カウンター" }, { 3628, "裁縫カウンター" },
            { 3630, "革細工カウンター" }, { 3627, "骨細工カウンター" }, { 3633, "錬金術カウンター" }, { 3629, "調理カウンター" },
            { 25632, "カービーキャップ" }, { 25633, "カービーキャップ+1" }, { 25604, "バファローキャップ" }, { 25713, "トラックシャツ" },
            { 27325, "トラックパンツ" }, { 25714, "トラックシャツ+1" }, { 27326, "トラックパンツ+1" }, { 3651, "ハーベストペストリ" },
            { 25711, "ボチュルススーツ" }, { 25712, "ボチュルススーツ+1" }, { 10925, "フィッシャトルク" }, { 10948, "木彫師トルク" },
            { 10949, "鍛冶師トルク" }, { 10950, "彫金師トルク" }, { 10951, "裁縫師トルク" }, { 10952, "革細工師トルク" },
            { 10953, "骨彫師トルク" }, { 10954, "錬金術師トルク" }, { 10955, "調理師トルク" }, { 25657, "バハムートヘッド" },
            { 25756, "バハムートスーツ" }, { 25658, "バハムートヘッド+1" }, { 25757, "バハムートスーツ+1" }, { 25909, "モルボルサブリガ" }, };
        /// <summary>エンピ109</summary>
        internal Itm StorageSlip20 { get; } = new( 110 ) {  // 7-14
            { 26740, "ボイイマスク" }, { 26898, "ボイイロリカ" }, { 27052, "ボイイマフラ" }, { 27237, "ボイイクウィス" }, { 27411, "ボイイカリガ" },
            { 26742, "ビッククラウン" }, { 26900, "ビックシクラス" }, { 27054, "ビックグローブ" }, { 27239, "ビックホーズ" }, { 27413, "ビックゲートル" },
            { 26744, "エーベルキャップ" }, { 26902, "エーベルブリオー" }, { 27056, "エーベルミトン" }, { 27241, "エーベルパンタロン" }, { 27415, "エーベルダックビル" },
            { 26746, "ウィッケペタソス" }, { 26904, "ウィッケコート" }, { 27058, "ウィッケグローブ" }, { 27243, "ウィッケショウス" }, { 27417, "ウィッケサボ" },
            { 26748, "レサジーシャペル" }, { 26906, "レサジーサヨン" }, { 27060, "レサジーガントロ" }, { 27245, "レサジーフュゾー" }, { 27419, "レサジーウゾー" },
            { 26750, "スカルカボンネット" }, { 26908, "スカルカベスト" }, { 27062, "スカルカアムレット" }, { 27247, "スカルカキュロット" }, { 27421, "スカルカプーレーヌ" },
            { 26752, "シバリエアーメット" }, { 26910, "シバリエキュイラス" }, { 27064, "シバリエガントレ" }, { 27249, "シバリエクウィス" }, { 27423, "シバリエサバトン" },
            { 26754, "ヒーズンバゴネット" }, { 26912, "ヒーズンキュイラス" }, { 27066, "ヒーズンガントレト" }, { 27251, "ヒーズンフランチャ" }, { 27425, "ヒーズンソルレット" },
            { 26756, "ヌグーミカバセ" }, { 26914, "ヌグーミゴーザプ" }, { 27068, "ヌグーミマノプラス" }, { 27253, "ヌグーミキホーテ" }, { 27427, "ヌグーミオクレア" },
            { 26758, "フィリキャロ" }, { 26916, "フィリオングルリヌ" }, { 27070, "フィリマンシェト" }, { 27255, "フィリラングラヴ" }, { 27429, "フィリコテュルヌ" },
            { 26760, "アミニガペット" }, { 26918, "アミニカバン" }, { 27072, "アミニグロブレト" }, { 27257, "アミニブラーグ" }, { 27431, "アミニボティヨン" },
            { 26762, "春日烏帽子形兜" }, { 26920, "春日胴丸" }, { 27074, "春日筒篭手" }, { 27259, "春日板佩楯" }, { 27433, "春日筒脛当" },
            { 26764, "服部頭巾" }, { 26922, "服部忍着" }, { 27076, "服部手甲" }, { 27261, "服部袴" }, { 27435, "服部脚絆" },
            { 26766, "ペルタスメザイユ" }, { 26924, "ペルタスプラカート" }, { 27078, "ペルタスバンブレス" }, { 27263, "ペルタスキュイソー" }, { 27437, "ペルタスシンバルド" },
            { 26768, "ベコナーホーン" }, { 26926, "ベコナーダブレット" }, { 27080, "ベコナーブレーサー" }, { 27265, "ベコナースパッツ" }, { 27439, "ベコナーピガッシュ" },
            { 26770, "ハシシンカヴク" }, { 26928, "ハシシンミンタン" }, { 27082, "ハシシンバズバンド" }, { 27267, "ハシシンタイト" }, { 27441, "ハシシンバシュマク" },
            { 26772, "シャスートリコルヌ" }, { 26930, "シャスーフラック" }, { 27084, "シャスーガントリー" }, { 27269, "シャスートルーズ" }, { 27443, "シャスーブーツ" },
            { 26774, "カラゴズカペッロ" }, { 26932, "カラゴズファルセト" }, { 27086, "カラゴズグアンティ" }, { 27271, "カラゴズパンタロニ" }, { 27445, "カラゴズスカルペ" },
            { 26776, "マクレレティアラ" }, { 26934, "マクレレカザク" }, { 27088, "マクレレバングル" }, { 27273, "マクレレタイツ" }, { 27447, "マクレレトーシュー" },
            { 26778, "アバテルボネット" }, { 26936, "アバテルガウン" }, { 27090, "アバテルブレーサー" }, { 27275, "アバテルパンツ" }, { 27449, "アバテルローファー" },
            { 26780, "アジムスフード" }, { 26938, "アジムスコート" }, { 27092, "アジムスグローブ" }, { 27277, "アジムスタイツ" }, { 27451, "アジムスゲートル" },
            { 26782, "エリラズガレア" }, { 26940, "エリラズサーコート" }, { 27094, "エリラズガントレ" }, { 27279, "エリラズレグガード" }, { 27453, "エリラズグリーヴ" }, };
        /// <summary>エンピ119</summary>
        internal Itm StorageSlip21 { get; } = new( 110 ) {  // 7-14
            { 26741, "BIマスク+1" }, { 26899, "BIロリカ+1" }, { 27053, "BIマフラ+1" }, { 27238, "BIクウィス+1" }, { 27412, "BIカリガ+1" },
            { 26743, "BKクラウン+1" }, { 26901, "BKシクラス+1" }, { 27055, "BKグローブ+1" }, { 27240, "BKホーズ+1" }, { 27414, "BKゲートル+1" },
            { 26745, "EBキャップ+1" }, { 26903, "EBブリオー+1" }, { 27057, "EBミトン+1" }, { 27242, "EBパンタロン+1" }, { 27416, "EBダックビル+1" },
            { 26747, "WCペタソス+1" }, { 26905, "WCコート+1" }, { 27059, "WCグローブ+1" }, { 27244, "WCショウス+1" }, { 27418, "WCサボ+1" },
            { 26749, "LTシャペル+1" }, { 26907, "LTサヨン+1" }, { 27061, "LTガントロ+1" }, { 27246, "LTフュゾー+1" }, { 27420, "LTウゾー+1" },
            { 26751, "SKボンネット+1" }, { 26909, "SKベスト+1" }, { 27063, "SKアムレット+1" }, { 27248, "SKキュロット+1" }, { 27422, "SKプーレーヌ+1" },
            { 26753, "CVアーメット+1" }, { 26911, "CVキュイラス+1" }, { 27065, "CVガントレ+1" }, { 27250, "CVクウィス+1" }, { 27424, "CVサバトン+1" },
            { 26755, "HTバゴネット+1" }, { 26913, "HTキュイラス+1" }, { 27067, "HTガントレト+1" }, { 27252, "HTフランチャ+1" }, { 27426, "HTソルレット+1" },
            { 26757, "NKカバセ+1" }, { 26915, "NKゴーザプ+1" }, { 27069, "NKマノプラス+1" }, { 27254, "NKキホーテ+1" }, { 27428, "NKオクレア+1" },
            { 26759, "FLキャロ+1" }, { 26917, "FLオングルリヌ+1" }, { 27071, "FLマンシェト+1" }, { 27256, "FLラングラヴ+1" }, { 27430, "FLコテュルヌ+1" },
            { 26761, "AMガペット+1" }, { 26919, "AMカバン+1" }, { 27073, "AMグロブレト+1" }, { 27258, "AMブラーグ+1" }, { 27432, "AMボティヨン+1" },
            { 26763, "春日烏帽子形兜改" }, { 26921, "春日胴丸改" }, { 27075, "春日筒篭手改" }, { 27260, "春日板佩楯改" }, { 27434, "春日筒脛当改" },
            { 26765, "服部頭巾改" }, { 26923, "服部忍着改" }, { 27077, "服部手甲改" }, { 27262, "服部袴改" }, { 27436, "服部脚絆改" },
            { 26767, "PEメザイユ+1" }, { 26925, "PEプラカート+1" }, { 27079, "PEバンブレス+1" }, { 27264, "PEキュイソー+1" }, { 27438, "PEシンバルド+1" },
            { 26769, "BCホーン+1" }, { 26927, "BCダブレット+1" }, { 27081, "BCブレーサー+1" }, { 27266, "BCスパッツ+1" }, { 27440, "BCピガッシュ+1" },
            { 26771, "HSカヴク+1" }, { 26929, "HSミンタン+1" }, { 27083, "HSバズバンド+1" }, { 27268, "HSタイト+1" }, { 27442, "HSバシュマク+1" },
            { 26773, "CSトリコルヌ+1" }, { 26931, "CSフラック+1" }, { 27085, "CSガントリー+1" }, { 27270, "CSトルーズ+1" }, { 27444, "CSブーツ+1" },
            { 26775, "KGカペッロ+1" }, { 26933, "KGファルセト+1" }, { 27087, "KGグアンティ+1" }, { 27272, "KGパンタロニ+1" }, { 27446, "KGスカルペ+1" },
            { 26777, "MCティアラ+1" }, { 26935, "MCカザク+1" }, { 27089, "MCバングル+1" }, { 27274, "MCタイツ+1" }, { 27448, "MCトーシュー+1" },
            { 26779, "ABボネット+1" }, { 26937, "ABガウン+1" }, { 27091, "ABブレーサー+1" }, { 27276, "ABパンツ+1" }, { 27450, "ABローファー+1" },
            { 26781, "AZフード+1" }, { 26939, "AZコート+1" }, { 27093, "AZグローブ+1" }, { 27278, "AZタイツ+1" }, { 27452, "AZゲートル+1" },
            { 26783, "ERガレア+1" }, { 26941, "ERサーコート+1" }, { 27095, "ERガントレ+1" }, { 27280, "ERレグガード+1" }, { 27454, "ERグリーヴ+1" }, };
        /// <summary>イベント報酬3</summary>
        internal Itm StorageSlip22 { get; } = new( 192 ) {
            { 25639, "コリガンマスク" }, { 25715, "コリガンスーツ" }, { 25638, "パキポンマスク" }, { 3707, "マリーグリザイユ" },
            { 3708, "モスグリザイユ" }, { 21074, "クポロッド" }, { 26406, "クポシールド" }, { 25645, "クポマスク" },
            { 25726, "クポスーツ" }, { 25648, "カームヘルメット" }, { 25649, "ゲイザーヘルメット" }, { 25650, "レチングヘルメット" },
            { 25758, "ラプソディシャツ" }, { 25759, "ラプソディシャツ+1" }, { 25672, "スノールマスク" }, { 25673, "スノールマスク+1" },
            { 282, "ヨヴラの像" }, { 279, "闇の王の像II" }, { 280, "闇の王の像III" }, { 268, "ノマドモーグリの像" },
            { 25670, "ララブキャップ" }, { 25671, "ララブキャップ+1" }, { 26520, "アキトゥシャツ" }, { 25652, "クラブキャップ" },
            { 25669, "クラブキャップ+1" }, { 22017, "盛夏団扇" }, { 22018, "盛夏団扇+1" }, { 25586, "カカイヘッド" },
            { 25587, "カカイヘッド+1" }, { 10384, "キュムラスマスク" }, { 10385, "キュムラスマスク+1" }, { 22019, "チャリロッド" },
            { 22020, "チャリロッド+1" }, { 25722, "ジュビリーシャツ" }, { 25585, "デストリアヘッド" }, { 25776, "デストリアスーツ" },
            { 25677, "アースロキャップ" }, { 25678, "アースロキャップ+1" }, { 25675, "白ララブキャップ" }, { 25679, "白ララブキャップ+1" },
            { 20668, "ファイアタン" }, { 20669, "ファイアタン+1" }, { 22069, "ハピスタッフ" }, { 25755, "クラステシンシャツ" },
            { 3722, "ライオンの像" }, { 21608, "オニオンソードII" }, { 3713, "ウォードポット" }, { 3714, "ホワイトクレマテス" },
            { 3715, "ピンククレマテス" }, { 3717, "カバノキ" }, { 3727, "ミュモルの像" }, { 3728, "ウルゴアの像" },
            { 20577, "チキンナイフII" }, { 3726, "アフマウの像" }, { 20666, "ブリザドブランド" }, { 20667, "ブリザドブランド+1" },
            { 21741, "魔人の斧" }, { 21609, "セイブザクイーンII" }, { 3723, "リリゼットの像" }, { 26410, "ダイアバックラー" },
            { 26411, "ダイアバックラー+1" }, { 25850, "ピンクサブリガ" }, { 21509, "プレミアムモグタス" }, { 3725, "コーネリアの像" },
            { 3720, "アシェラの像" }, { 21658, "ブレイブブレイドII" }, { 26524, "ギルナバーシャツ" }, { 20665, "カムラナートの剣" },
            { 26412, "カムラナートの盾" }, { 21965, "斬魔刀" }, { 21966, "斬魔刀改" }, { 21967, "西瓜割の太刀" },
            { 25774, "ファンシージレ" }, { 25838, "ファンシーボクサー" }, { 25775, "ファンシートップ" }, { 25839, "ファンシーショーツ" },
            { 3724, "ウカの像" }, { 3721, "イロハの像" }, { 21682, "ラメント" }, { 22072, "ラミアの杖" },
            { 21820, "ロスシックル" }, { 21821, "ロスシックル+1" }, { 23731, "Rチョコボキャップ" }, { 26517, "Sロードシャツ" },
            { 23730, "カラクールキャップ" }, { 20573, "アーンダガー" }, { 20674, "アーンソード" }, { 21742, "アーンアクス" },
            { 21860, "アーンスピア" }, { 22065, "アーンスタッフ" }, { 22039, "羽子板【華】" }, { 22124, "アルテミスの弓" },
            { 22132, "アルテミスの弓+1" }, { 3719, "プリッシュの像II" }, { 3738, "和傘" }, { 26518, "ジョディシャツ" },
            { 27623, "ジョディシールド" }, { 21867, "沙悟浄の槍" }, { 21868, "沙悟浄の槍+1" }, { 22283, "マーベラスチア" },
            { 26516, "キトルルスシャツ" }, { 20933, "方天戟" }, { 20578, "ウィンドナイフ" }, { 20568, "ウィンドナイフ+1" },
            { 3739, "紅葉" }, { 20569, "エシクーバ" }, { 20570, "ノルギッシュダガー" }, { 22288, "マンドラケース" },
            { 26352, "モグサコッシュ" }, { 23737, "白虎マスク" }, { 22282, "不倶戴天" }, { 3740, "模倣錬成窯" },
            { 3741, "模倣錬成窯II" }, { 26545, "ミスカバブシャツ" }, { 21977, "陸奥守" }, { 21978, "陸奥守改" },
            { 3742, "ようじんぼうの絵画" }, { 26519, "マンドラシャツ" }, { 26514, "ポロッゴフリース" }, { 26515, "ポロッゴフリース+1" },
            { 3743, "モーグリベッド" }, { 21636, "ナイヒリティ" }, { 23753, "三度笠" }, { 23754, "三度笠+1" },
            { 54, "チョコボコモード" }, { 25910, "ケットサブリガ" }, { 20571, "インフィルトレータ" }, { 23790, "アデニウムマスク" },
            { 23791, "アデニウムスーツ" }, { 26489, "水影の盾" }, { 22153, "シルバーガン" }, { 22154, "シルバーガン+1" },
            { 20574, "アーンダガーII" }, { 20675, "アーンソードII" }, { 21743, "アーンアクスII" }, { 21861, "アーンスピアII" },
            { 22066, "アーンスタッフII" }, { 3748, "リフキンベッド" }, { 21638, "エクステンクション" }, { 23800, "カンクリエプロン" },
            { 23801, "カンクリエプロン+1" }, { 3749, "試験薬セット" }, { 3750, "キキルンの願い箱" }, { 22045, "羽子板【金虎】" },
            { 22046, "羽子板【金虎】+1" }, { 3751, "魔道紋テーブル" }, { 26490, "アークシールド" }, { 26546, "モーグリシャツ" },
            { 22047, "コリガンマレット" }, { 22048, "アデニウムマレット" }, { 22049, "キトルルスマレット" }, { 23803, "ポロッゴカソック" },
            { 23804, "ポロッゴカソック+1" }, { 22051, "リコポンマレット" }, { 22052, "暑夏団扇" }, { 3752, "コリブリベッド" },
            { 23805, "モルボルエプロン" }, { 25911, "デニムズボン" }, { 25912, "デニムズボン+1" }, { 3753, "蒼剣の丘" },
            { 23806, "バケーロハット" }, { 3754, "鏡餅" }, { 23810, "ニットキャップ" }, { 23811, "ニットキャップ+1" },
            { 3755, "レインボーチェスト" }, { 26496, "えぇぢす" }, { 26497, "いぃぢす" }, { 21786, "ポイズンアクス" },
            { 21787, "ポイズンアクス+1" }, { 21996, "マジシャンロッド" }, { 21997, "マジシャンロッド+1" }, { 23802, "オクーバクラウン" },
            { 25777, "郎子法被" }, { 25778, "郎女法被" }, { 21933, "柳生の小太刀" }, { 21934, "柳生の小太刀改" },
            { 21993, "識者の杖" }, { 21994, "識者の杖+1" }, { 23866, "ユールタリスマン" }, { 20670, "マカナ" },
            { 21537, "リザードファング" }, { 21538, "リザードファング+1" }, { 21572, "エソテリックアサメ" }, { 23870, "エイルキャップ" },
            { 21760, "デスパチャアックス" }, { 23871, "ヘベヌスジレ" }, { 23872, "ヘベヌスボクサー" }, { 23873, "ヘベヌストップ" },
            { 23874, "ヘベヌスショーツ" }, { 20691, "九鈎刀" }, { 23893, "ダルメルトラウザ" }, { 26522, "タジャウジョシャン" }, };
        /// <summary>バスケ</summary>
        internal Itm StorageSlip23 { get; } = new( 177 ) {  // 12-1
            { 25659, "スレビアマスク" }, { 25745, "スレビアプレート" }, { 25800, "スレビアガントレ" }, { 25858, "スレビアクウィス" }, { 25925, "スレビアレギンス" },
            { 25660, "スレビアマスク+1" }, { 25746, "スレビアプレート+1" }, { 25801, "スレビアガントレ+1" }, { 25859, "スレビアクウィス+1" }, { 25926, "スレビアレギンス+1" },
            { 25663, "膝丸総面" }, { 25749, "膝丸腹巻" }, { 25804, "膝丸篭手" }, { 25862, "膝丸膝甲" }, { 25929, "膝丸脛当" },
            { 25664, "膝丸総面改" }, { 25750, "膝丸腹巻改" }, { 25805, "膝丸篭手改" }, { 25863, "膝丸膝甲改" }, { 25930, "膝丸脛当改" },
            { 25665, "インヤガティアラ" }, { 25751, "インヤガジュバ" }, { 25806, "インヤガダスタナ" }, { 25865, "インヤガシャルワ" }, { 25931, "インヤガクラッコ" },
            { 25666, "インヤガティアラ+1" }, { 25752, "インヤガジュバ+1" }, { 25807, "インヤガダスタナ+1" }, { 25866, "インヤガシャルワ+1" }, { 25932, "インヤガクラッコ+1" },
            { 25661, "メガナダバイザー" }, { 25747, "メガナダクウィリ" }, { 25802, "メガナダグローブ" }, { 25860, "メガナダショウス" }, { 25927, "メガナダジャンボ" },
            { 25662, "メガナダバイザー+1" }, { 25748, "メガナダクウィリ+1" }, { 25803, "メガナダグローブ+1" }, { 25861, "メガナダショウス+1" }, { 25928, "メガナダジャンボ+1" },
            { 25667, "ジャリコロナル" }, { 25753, "ジャリローブ" }, { 25808, "ジャリカフス" }, { 25867, "ジャリスロップス" }, { 25933, "ジャリピガッシュ" },
            { 25668, "ジャリコロナル+1" }, { 25754, "ジャリローブ+1" }, { 25809, "ジャリカフス+1" }, { 25868, "ジャリスロップス+1" }, { 25934, "ジャリピガッシュ+1" },
            { 25579, "フラマツッケット" }, { 25779, "フラマコラジン" }, { 25818, "フラママノポラ" }, { 25873, "フラマディル" }, { 25940, "フラマガンビエラ" },
            { 25580, "フラマツッケット+1" }, { 25780, "フラマコラジン+1" }, { 25819, "フラママノポラ+1" }, { 25874, "フラマディル+1" }, { 25941, "フラマガンビエラ+1" },
            { 25590, "タリアターバン" }, { 25764, "タリアマンティル" }, { 25812, "タリアゲージ" }, { 25871, "タリアサラウィル" }, { 25937, "タリアクラッコー" },
            { 25591, "タリアターバン+1" }, { 25765, "タリアマンティル+1" }, { 25813, "タリアゲージ+1" }, { 25872, "タリアサラウィル+1" }, { 25938, "タリアクラッコー+1" },
            { 25581, "ムンムボンネット" }, { 25781, "ムンムジャケット" }, { 25820, "ムンムリスト" }, { 25875, "ムンムケックス" }, { 25942, "ムンムゲマッシュ" },
            { 25582, "ムンムボンネット+1" }, { 25782, "ムンムジャケット+1" }, { 25821, "ムンムリスト+1" }, { 25876, "ムンムケックス+1" }, { 25943, "ムンムゲマッシュ+1" },
            { 25588, "アヤモツッケット" }, { 25762, "アヤモコラッツァ" }, { 25810, "アヤモマノポラ" }, { 25869, "アヤモコッシャレ" }, { 25935, "アヤモガンビエラ" },
            { 25589, "アヤモツッケット+1" }, { 25763, "アヤモコラッツァ+1" }, { 25811, "アヤモマノポラ+1" }, { 25870, "アヤモコッシャレ+1" }, { 25936, "アヤモガンビエラ+1" },
            { 25583, "マルクィシャポー" }, { 25783, "マルクィサイオ" }, { 25822, "マルクィカフス" }, { 25877, "マルクィトルーズ" }, { 25944, "マルクィクロッグ" },
            { 25584, "マルクィシャポー+1" }, { 25784, "マルクィサイオ+1" }, { 25823, "マルクィカフス+1" }, { 25878, "マルクィトルーズ+1" }, { 25945, "マルクィクロッグ+1" },
            { 25574, "スレビアマスク+2" }, { 25790, "スレビアプレート+2" }, { 25828, "スレビアガントレ+2" }, { 25879, "スレビアクウィス+2" }, { 25946, "スレビアレギンス+2" },
            { 25575, "メガナダバイザー+2" }, { 25791, "メガナダクウィリ+2" }, { 25829, "メガナダグローブ+2" }, { 25880, "メガナダショウス+2" }, { 25947, "メガナダジャンボ+2" },
            { 25576, "真膝丸総面" }, { 25792, "真膝丸腹巻" }, { 25830, "真膝丸篭手" }, { 25881, "真膝丸膝甲" }, { 25948, "真膝丸脛当" },
            { 25577, "インヤガティアラ+2" }, { 25793, "インヤガジュバ+2" }, { 25831, "インヤガダスタナ+2" }, { 25882, "インヤガシャルワ+2" }, { 25949, "インヤガクラッコ+2" },
            { 25578, "ジャリコロナル+2" }, { 25794, "ジャリローブ+2" }, { 25832, "ジャリカフス+2" }, { 25883, "ジャリスロップス+2" }, { 25950, "ジャリピガッシュ+2" },
            { 26204, "スレビアリング" }, { 26205, "メガナダリング" }, { 26206, "膝丸の指輪" }, { 26207, "インヤガリング" }, { 26208, "ジャリリング" },
            { 25569, "フラマツッケット+2" }, { 25797, "フラマコラジン+2" }, { 25835, "フラママノポラ+2" }, { 25886, "フラマディル+2" }, { 25953, "フラマガンビエラ+2" },
            { 25573, "タリアターバン+2" }, { 25796, "タリアマンティル+2" }, { 25834, "タリアゲージ+2" }, { 25885, "タリアサラウィル+2" }, { 25952, "タリアクラッコー+2" },
            { 25570, "ムンムボンネット+2" }, { 25798, "ムンムジャケット+2" }, { 25836, "ムンムリスト+2" }, { 25887, "ムンムケックス+2" }, { 25954, "ムンムゲマッシュ+2" },
            { 25572, "アヤモツッケット+2" }, { 25795, "アヤモコラッツァ+2" }, { 25833, "アヤモマノポラ+2" }, { 25884, "アヤモコッシャレ+2" }, { 25951, "アヤモガンビエラ+2" },
            { 25571, "マルクィシャポー+2" }, { 25799, "マルクィサイオ+2" }, { 25837, "マルクィカフス+2" }, { 25888, "マルクィトルーズ+2" }, { 25955, "マルクィクロッグ+2" },
            { 26211, "フラマリング" }, { 26210, "タリアリング" }, { 26212, "ムンムリング" }, { 26209, "アヤモリング" }, { 26213, "マルクィリング" },
            { 21863, "ヅェーシシュの薙刀" }, { 22004, "ソウルフレアワンド" }, { 21744, "グラムクの石斧" }, { 21272, "トロールガン" },
            { 20576, "クトゥルブナイフ" }, { 21761, "ザダチョッパー" }, { 26409, "デュラハンの盾" }, { 22070, "レイナインスタッフ" },
            { 21681, "オフィデアンソード" }, { 22005, "バロアーワンド" }, { 21745, "デュラハンの斧" }, { 22068, "サヴェージポール" },
            { 21759, "オータークアックス" }, { 21770, "ヘルゴランド" }, { 22067, "レヴェン" }, { 21680, "ゴージエン" }, { 22071, "コースの杖" }, };
        /// <summary>AF119+2</summary>
        internal Itm StorageSlip24 { get; } = new( 115 ) {  // 8-3
            { 23040, "PMマスク+2" }, { 23107, "PMロリカ+2" }, { 23174, "PMマフラ+2" }, { 23241, "PMクウィス+2" }, { 23308, "PMカリガ+2" },
            { 23041, "ANクラウン+2" }, { 23108, "ANシクラス+2" }, { 23175, "ANグローブ+2" }, { 23242, "ANホーズ+2" }, { 23309, "ANゲートル+2" },
            { 23042, "TEキャップ+2" }, { 23109, "TEブリオー+2" }, { 23176, "TEミトン+2" }, { 23243, "TEパンタロン+2" }, { 23310, "TEダックビル+2" },
            { 23043, "SPペタソス+2" }, { 23110, "SPコート+2" }, { 23177, "SPグローブ+2" }, { 23244, "SPトンバン+2" }, { 23311, "SPサボ+2" },
            { 23044, "ATシャポー+2" }, { 23111, "ATタバード+2" }, { 23178, "ATグローブ+2" }, { 23245, "ATタイツ+2" }, { 23312, "ATブーツ+2" },
            { 23045, "PLボンネット+2" }, { 23112, "PLベスト+2" }, { 23179, "PLアムレット+2" }, { 23246, "PLキュロット+2" }, { 23313, "PLプーレーヌ+2" },
            { 23046, "RVコロネット+2" }, { 23113, "RVサーコート+2" }, { 23180, "RVガントレ+2" }, { 23247, "RVブリーチズ+2" }, { 23314, "RVレギンス+2" },
            { 23047, "IGバゴネット+2" }, { 23114, "IGキュイラス+2" }, { 23181, "IGガントレ+2" }, { 23248, "IGフランチャ+2" }, { 23315, "IGソルレット+2" },
            { 23048, "TOヘルム+2" }, { 23115, "TOジャック+2" }, { 23182, "TOグローブ+2" }, { 23249, "TOトラウザ+2" }, { 23316, "TOゲートル+2" },
            { 23049, "BRランドリト+2" }, { 23116, "BRジュスト+2" }, { 23183, "BRカフス+2" }, { 23250, "BRキャニオン+2" }, { 23317, "BRスリッパー+2" },
            { 23050, "ORベレー+2" }, { 23117, "ORジャーキン+2" }, { 23184, "ORブレーサー+2" }, { 23251, "ORブラッカエ+2" }, { 23318, "ORソックス+2" },
            { 23051, "真脇戸桃形兜" }, { 23118, "真脇戸胴丸" }, { 23185, "真脇戸筒篭手" }, { 23252, "真脇戸板佩楯" }, { 23319, "真脇戸筒脛当" },
            { 23052, "真蜂屋半首" }, { 23119, "真蜂屋鎖帷子" }, { 23186, "真蜂屋手甲" }, { 23253, "真蜂屋袴" }, { 23320, "真蜂屋脚絆" },
            { 23053, "VSアーメット+2" }, { 23120, "VSメイル+2" }, { 23187, "VSフィンガー+2" }, { 23254, "VSブレー+2" }, { 23321, "VSグリーヴ+2" },
            { 23054, "CNホーン+2" }, { 23121, "CNダブレット+2" }, { 23188, "CNブレーサー+2" }, { 23255, "CNスパッツ+2" }, { 23322, "CNピガッシュ+2" },
            { 23055, "ASケフィエ+2" }, { 23122, "ASジュバ+2" }, { 23189, "ASバズバンド+2" }, { 23256, "ASシャルワー+2" }, { 23323, "ASチャルク+2" },
            { 23056, "LKトリコルヌ+2" }, { 23123, "LKフラック+2" }, { 23190, "LKガントリー+2" }, { 23257, "LKトルーズ+2" }, { 23324, "LKブーツ+2" },
            { 23057, "FOタージ+2" }, { 23124, "FOトベ+2" }, { 23191, "FOダスタナ+2" }, { 23258, "FOチュリダル+2" }, { 23325, "FOバブーシュ+2" },
            { 23058, "MXティアラ+2♂" }, { 23125, "MXカザク+2♂" }, { 23192, "MXバングル+2♂" }, { 23259, "MXタイツ+2♂" }, { 23326, "MXトーシュー+2♂" },
            { 23059, "MXティアラ+2♀" }, { 23126, "MXカザク+2♀" }, { 23193, "MXバングル+2♀" }, { 23260, "MXタイツ+2♀" }, { 23327, "MXトーシュー+2♀" },
            { 23060, "ACボード+2" }, { 23127, "ACガウン+2" }, { 23194, "ACブレーサー+2" }, { 23261, "ACパンツ+2" }, { 23328, "ACローファー+2" },
            { 23061, "GOガレーロ+2" }, { 23128, "GOチュニック+2" }, { 23195, "GOミテーヌ+2" }, { 23262, "GOパンツ+2" }, { 23329, "GOサンダル+2" },
            { 23062, "RNバンド+2" }, { 23129, "RNコート+2" }, { 23196, "RNミトン+2" }, { 23263, "RNトラウザ+2" }, { 23330, "RNブーツ+2" } };
        /// <summary>AF119+3</summary>
        internal Itm StorageSlip25 { get; } = new( 115 ) {  // 8-3
            { 23375, "PMマスク+3" }, { 23442, "PMロリカ+3" }, { 23509, "PMマフラ+3" }, { 23576, "PMクウィス+3" }, { 23643, "PMカリガ+3" },
            { 23376, "ANクラウン+3" }, { 23443, "ANシクラス+3" }, { 23510, "ANグローブ+3" }, { 23577, "ANホーズ+3" }, { 23644, "ANゲートル+3" },
            { 23377, "TEキャップ+3" }, { 23444, "TEブリオー+3" }, { 23511, "TEミトン+3" }, { 23578, "TEパンタロン+3" }, { 23645, "TEダックビル+3" },
            { 23378, "SPペタソス+3" }, { 23445, "SPコート+3" }, { 23512, "SPグローブ+3" }, { 23579, "SPトンバン+3" }, { 23646, "SPサボ+3" },
            { 23379, "ATシャポー+3" }, { 23446, "ATタバード+3" }, { 23513, "ATグローブ+3" }, { 23580, "ATタイツ+3" }, { 23647, "ATブーツ+3" },
            { 23380, "PLボンネット+3" }, { 23447, "PLベスト+3" }, { 23514, "PLアムレット+3" }, { 23581, "PLキュロット+3" }, { 23648, "PLプーレーヌ+3" },
            { 23381, "RVコロネット+3" }, { 23448, "RVサーコート+3" }, { 23515, "RVガントレ+3" }, { 23582, "RVブリーチズ+3" }, { 23649, "RVレギンス+3" },
            { 23382, "IGバゴネット+3" }, { 23449, "IGキュイラス+3" }, { 23516, "IGガントレ+3" }, { 23583, "IGフランチャ+3" }, { 23650, "IGソルレット+3" },
            { 23383, "TOヘルム+3" }, { 23450, "TOジャック+3" }, { 23517, "TOグローブ+3" }, { 23584, "TOトラウザ+3" }, { 23651, "TOゲートル+3" },
            { 23384, "BRランドリト+3" }, { 23451, "BRジュスト+3" }, { 23518, "BRカフス+3" }, { 23585, "BRキャニオン+3" }, { 23652, "BRスリッパー+3" },
            { 23385, "ORベレー+3" }, { 23452, "ORジャーキン+3" }, { 23519, "ORブレーサー+3" }, { 23586, "ORブラッカエ+3" }, { 23653, "ORソックス+3" },
            { 23386, "極脇戸桃形兜" }, { 23453, "極脇戸胴丸" }, { 23520, "極脇戸筒篭手" }, { 23587, "極脇戸板佩楯" }, { 23654, "極脇戸筒脛当" },
            { 23387, "極蜂屋半首" }, { 23454, "極蜂屋鎖帷子" }, { 23521, "極蜂屋手甲" }, { 23588, "極蜂屋袴" }, { 23655, "極蜂屋脚絆" },
            { 23388, "VSアーメット+3" }, { 23455, "VSメイル+3" }, { 23522, "VSフィンガー+3" }, { 23589, "VSブレー+3" }, { 23656, "VSグリーヴ+3" },
            { 23389, "CNホーン+3" }, { 23456, "CNダブレット+3" }, { 23523, "CNブレーサー+3" }, { 23590, "CNスパッツ+3" }, { 23657, "CNピガッシュ+3" },
            { 23390, "ASケフィエ+3" }, { 23457, "ASジュバ+3" }, { 23524, "ASバズバンド+3" }, { 23591, "ASシャルワー+3" }, { 23658, "ASチャルク+3" },
            { 23391, "LKトリコルヌ+3" }, { 23458, "LKフラック+3" }, { 23525, "LKガントリー+3" }, { 23592, "LKトルーズ+3" }, { 23659, "LKブーツ+3" },
            { 23392, "FOタージ+3" }, { 23459, "FOトベ+3" }, { 23526, "FOダスタナ+3" }, { 23593, "FOチュリダル+3" }, { 23660, "FOバブーシュ+3" },
            { 23393, "MXティアラ+3♂" }, { 23460, "MXカザク+3♂" }, { 23527, "MXバングル+3♂" }, { 23594, "MXタイツ+3♂" }, { 23661, "MXトーシュー+3♂" },
            { 23394, "MXティアラ+3♀" }, { 23461, "MXカザク+3♀" }, { 23528, "MXバングル+3♀" }, { 23595, "MXタイツ+3♀" }, { 23662, "MXトーシュー+3♀" },
            { 23395, "ACボード+3" }, { 23462, "ACガウン+3" }, { 23529, "ACブレーサー+3" }, { 23596, "ACパンツ+3" }, { 23663, "ACローファー+3" },
            { 23396, "GOガレーロ+3" }, { 23463, "GOチュニック+3" }, { 23530, "GOミテーヌ+3" }, { 23597, "GOパンツ+3" }, { 23664, "GOサンダル+3" },
            { 23397, "RNバンド+3" }, { 23464, "RNコート+3" }, { 23531, "RNミトン+3" }, { 23598, "RNトラウザ+3" }, { 23665, "RNブーツ+3" } };
        /// <summary>レリック119+2</summary>
        internal Itm StorageSlip26 { get; } = new( 110 ) {  // 7-14
            { 23063, "AGマスク+2" }, { 23130, "AGロリカ+2" }, { 23197, "AGマフラ+2" }, { 23264, "AGクウィス+2" }, { 23331, "AGカリガ+2" },
            { 23064, "HEクラウン+2" }, { 23131, "HEシクラス+2" }, { 23198, "HEグローブ+2" }, { 23265, "HEホーズ+2" }, { 23332, "HEゲートル+2" },
            { 23065, "PIキャップ+2" }, { 23132, "PIブリオー+2" }, { 23199, "PIミトン+2" }, { 23266, "PIパンタロン+2" }, { 23333, "PIダックビル+2" },
            { 23066, "ARペタソス+2" }, { 23133, "ARコート+2" }, { 23200, "ARグローブ+2" }, { 23267, "ARトンバン+2" }, { 23334, "ARサボ+2" },
            { 23067, "VIシャポー+2" }, { 23134, "VIタバード+2" }, { 23201, "VIグローブ+2" }, { 23268, "VIタイツ+2" }, { 23335, "VIブーツ+2" },
            { 23068, "PDボンネット+2" }, { 23135, "PDベスト+2" }, { 23202, "PDアムレット+2" }, { 23269, "PDキュロット+2" }, { 23336, "PDプーレーヌ+2" },
            { 23069, "CBコロネット+2" }, { 23136, "CBサーコート+2" }, { 23203, "CBガントレ+2" }, { 23270, "CBブリーチズ+2" }, { 23337, "CBレギンス+2" },
            { 23070, "FLバーゴネット+2" }, { 23137, "FLキュイラス+2" }, { 23204, "FLガントレット+2" }, { 23271, "FLフランチャー+2" }, { 23338, "FLソルレット+2" },
            { 23071, "AKヘルム+2" }, { 23138, "AKジャック+2" }, { 23205, "AKグローブ+2" }, { 23272, "AKトラウザ+2" }, { 23339, "AKゲートル+2" },
            { 23072, "BIラウンドリト+2" }, { 23139, "BIジュストコル+2" }, { 23206, "BIカフス+2" }, { 23273, "BIキャニオンズ+2" }, { 23340, "BIスリッパー+2" },
            { 23073, "ARベレー+2" }, { 23140, "ARジャーキン+2" }, { 23207, "ARブレーサー+2" }, { 23274, "ARブラッカエ+2" }, { 23341, "ARソックス+2" },
            { 23074, "真左近士桃形兜" }, { 23141, "真左近士胴丸" }, { 23208, "真左近士筒篭手" }, { 23275, "真左近士板佩楯" }, { 23342, "真左近士筒脛当" },
            { 23075, "真望月半首" }, { 23142, "真望月鎖帷子" }, { 23209, "真望月手甲" }, { 23276, "真望月袴" }, { 23343, "真望月脚絆" },
            { 23076, "PTアーメット+2" }, { 23143, "PTメイル+2" }, { 23210, "PTフィンガー+2" }, { 23277, "PTブレー+2" }, { 23344, "PTグリーヴ+2" },
            { 23077, "GLホーン+2" }, { 23144, "GLダブレット+2" }, { 23211, "GLブレーサー+2" }, { 23278, "GLスパッツ+2" }, { 23345, "GLピガッシュ+2" },
            { 23078, "LLケフィエ+2" }, { 23145, "LLジュバ+2" }, { 23212, "LLバズバンド+2" }, { 23279, "LLシャルワー+2" }, { 23346, "LLチャルク+2" },
            { 23079, "LAトリコルヌ+2" }, { 23146, "LAフラック+2" }, { 23213, "LAガントリー+2" }, { 23280, "LAトルーズ+2" }, { 23347, "LAブーツ+2" },
            { 23080, "PIタージ+2" }, { 23147, "PIトベ+2" }, { 23214, "PIダスタナ+2" }, { 23281, "PIチュリダル+2" }, { 23348, "PIバブーシュ+2" },
            { 23081, "HOティアラ+2" }, { 23148, "HOカザク+2" }, { 23215, "HOバングル+2" }, { 23282, "HOタイツ+2" }, { 23349, "HOトーシュー+2" },
            { 23082, "PDボード+2" }, { 23149, "PDガウン+2" }, { 23216, "PDブレーサー+2" }, { 23283, "PDパンツ+2" }, { 23350, "PDローファー+2" },
            { 23083, "BAガレーロ+2" }, { 23150, "BAチュニック+2" }, { 23217, "BAミテーヌ+2" }, { 23284, "BAパンツ+2" }, { 23351, "BAサンダル+2" },
            { 23084, "FUバンド+2" }, { 23151, "FUコート+2" }, { 23218, "FUミトン+2" }, { 23285, "FUトラウザ+2" }, { 23352, "FUブーツ+2" } };
        /// <summary>レリック119+3</summary>
        internal Itm StorageSlip27 { get; } = new( 110 ) {  // 7-14
            { 23398, "AGマスク+3" }, { 23465, "AGロリカ+3" }, { 23532, "AGマフラ+3" }, { 23599, "AGクウィス+3" }, { 23666, "AGカリガ+3" },
            { 23399, "HEクラウン+3" }, { 23466, "HEシクラス+3" }, { 23533, "HEグローブ+3" }, { 23600, "HEホーズ+3" }, { 23667, "HEゲートル+3" },
            { 23400, "PIキャップ+3" }, { 23467, "PIブリオー+3" }, { 23534, "PIミトン+3" }, { 23601, "PIパンタロン+3" }, { 23668, "PIダックビル+3" },
            { 23401, "ARペタソス+3" }, { 23468, "ARコート+3" }, { 23535, "ARグローブ+3" }, { 23602, "ARトンバン+3" }, { 23669, "ARサボ+3" },
            { 23402, "VIシャポー+3" }, { 23469, "VIタバード+3" }, { 23536, "VIグローブ+3" }, { 23603, "VIタイツ+3" }, { 23670, "VIブーツ+3" },
            { 23403, "PDボンネット+3" }, { 23470, "PDベスト+3" }, { 23537, "PDアムレット+3" }, { 23604, "PDキュロット+3" }, { 23671, "PDプーレーヌ+3" },
            { 23404, "CBコロネット+3" }, { 23471, "CBサーコート+3" }, { 23538, "CBガントレ+3" }, { 23605, "CBブリーチズ+3" }, { 23672, "CBレギンス+3" },
            { 23405, "FLバーゴネット+3" }, { 23472, "FLキュイラス+3" }, { 23539, "FLガントレット+3" }, { 23606, "FLフランチャー+3" }, { 23673, "FLソルレット+3" },
            { 23406, "AKヘルム+3" }, { 23473, "AKジャック+3" }, { 23540, "AKグローブ+3" }, { 23607, "AKトラウザ+3" }, { 23674, "AKゲートル+3" },
            { 23407, "BIラウンドリト+3" }, { 23474, "BIジュストコル+3" }, { 23541, "BIカフス+3" }, { 23608, "BIキャニオンズ+3" }, { 23675, "BIスリッパー+3" },
            { 23408, "ARベレー+3" }, { 23475, "ARジャーキン+3" }, { 23542, "ARブレーサー+3" }, { 23609, "ARブラッカエ+3" }, { 23676, "ARソックス+3" },
            { 23409, "極左近士桃形兜" }, { 23476, "極左近士胴丸" }, { 23543, "極左近士筒篭手" }, { 23610, "極左近士板佩楯" }, { 23677, "極左近士筒脛当" },
            { 23410, "極望月半首" }, { 23477, "極望月鎖帷子" }, { 23544, "極望月手甲" }, { 23611, "極望月袴" }, { 23678, "極望月脚絆" },
            { 23411, "PTアーメット+3" }, { 23478, "PTメイル+3" }, { 23545, "PTフィンガー+3" }, { 23612, "PTブレー+3" }, { 23679, "PTグリーヴ+3" },
            { 23412, "GLホーン+3" }, { 23479, "GLダブレット+3" }, { 23546, "GLブレーサー+3" }, { 23613, "GLスパッツ+3" }, { 23680, "GLピガッシュ+3" },
            { 23413, "LLケフィエ+3" }, { 23480, "LLジュバ+3" }, { 23547, "LLバズバンド+3" }, { 23614, "LLシャルワー+3" }, { 23681, "LLチャルク+3" },
            { 23414, "LAトリコルヌ+3" }, { 23481, "LAフラック+3" }, { 23548, "LAガントリー+3" }, { 23615, "LAトルーズ+3" }, { 23682, "LAブーツ+3" },
            { 23415, "PIタージ+3" }, { 23482, "PIトベ+3" }, { 23549, "PIダスタナ+3" }, { 23616, "PIチュリダル+3" }, { 23683, "PIバブーシュ+3" },
            { 23416, "HOティアラ+3" }, { 23483, "HOカザク+3" }, { 23550, "HOバングル+3" }, { 23617, "HOタイツ+3" }, { 23684, "HOトーシュー+3" },
            { 23417, "PDボード+3" }, { 23484, "PDガウン+3" }, { 23551, "PDブレーサー+3" }, { 23618, "PDパンツ+3" }, { 23685, "PDローファー+3" },
            { 23418, "BAガレーロ+3" }, { 23485, "BAチュニック+3" }, { 23552, "BAミテーヌ+3" }, { 23619, "BAパンツ+3" }, { 23686, "BAサンダル+3" },
            { 23419, "FUバンド+3" }, { 23486, "FUコート+3" }, { 23553, "FUミトン+3" }, { 23620, "FUトラウザ+3" }, { 23687, "FUブーツ+3" } };
        /// <summary>バスケ2</summary>
        internal Itm StorageSlip28 { get; } = new( 71 ) {   // 5-7
            { 21515, "トッコナックル" }, { 21561, "トッコナイフ" }, { 21617, "トッコソード" }, { 21670, "トッコクレイモア" }, { 21718, "トッコアクス" }, { 21775, "トッコチョッパー" }, { 21826, "トッコサイズ" },
            { 21879, "トッコランス" }, { 21918, "トッコカタナ" }, { 21971, "トッコタチ" }, { 22027, "トッコロッド" }, { 22082, "トッコスタッフ" }, { 22108, "トッコボウ" }, { 22214, "トッコグリップ" },
            { 21516, "アジャナックル" }, { 21562, "アジャナイフ" }, { 21618, "アジャソード" }, { 21671, "アジャクレイモア" }, { 21719, "アジャアクス" }, { 21776, "アジャチョッパー" }, { 21827, "アジャサイズ" },
            { 21880, "アジャランス" }, { 21919, "アジャカタナ" }, { 21972, "アジャタチ" }, { 22028, "アジャロッド" }, { 22083, "アジャスタッフ" }, { 22109, "アジャボウ" }, { 22215, "アジャグリップ" },
            { 21517, "エレタナックル" }, { 21563, "エレタナイフ" }, { 21619, "エレタソード" }, { 21672, "エレタクレイモア" }, { 21720, "エレタアクス" }, { 21777, "エレタチョッパー" }, { 21828, "エレタサイズ" },
            { 21881, "エレタランス" }, { 21920, "エレタカタナ" }, { 21973, "エレタタチ" }, { 22029, "エレタロッド" }, { 22084, "エレタスタッフ" }, { 22110, "エレタボウ" }, { 22216, "エレタグリップ" },
            { 21518, "カジャナックル" }, { 21564, "カジャナイフ" }, { 21620, "カジャソード" }, { 21673, "カジャクレイモア" }, { 21721, "カジャアクス" }, { 21778, "カジャチョッパー" }, { 21829, "カジャサイズ" },
            { 21882, "カジャランス" }, { 21921, "カジャカタナ" }, { 21974, "カジャタチ" }, { 22030, "カジャロッド" }, { 22085, "カジャスタッフ" }, { 22111, "カジャボウ" }, { 22217, "カジャグリップ" },
            { 21519, "カランビット" }, { 21565, "トーレット" }, { 21621, "ネイグリング" }, { 21674, "ナンダカ" }, { 21722, "ドリケナス" },
            { 21779, "ライカーゴス" }, { 21830, "ドレパナム" }, { 21883, "シャイニングワン" }, { 21922, "五虎退" }, { 21975, "八文字" },
            { 22031, "マクセンチアス" }, { 22086, "ゾアノン" }, { 22107, "ウルル" }, { 22218, "コーンスー" }, { 22089, "ソフィストリー" }, };
        /// <summary>エンピ119+2</summary>
        internal Itm StorageSlip29 { get; } = new( 110 ) {  // 7-14
            { 23085, "BIマスク+2" }, { 23152, "BIロリカ+2" }, { 23219, "BIマフラ+2" }, { 23286, "BIクウィス+2" }, { 23353, "BIカリガ+2" },
            { 23086, "BKクラウン+2" }, { 23153, "BKシクラス+2" }, { 23220, "BKグローブ+2" }, { 23287, "BKホーズ+2" }, { 23354, "BKゲートル+2" },
            { 23087, "EBキャップ+2" }, { 23154, "EBブリオー+2" }, { 23221, "EBミトン+2" }, { 23288, "EBパンタロン+2" }, { 23355, "EBダックビル+2" },
            { 23088, "WCペタソス+2" }, { 23155, "WCコート+2" }, { 23222, "WCグローブ+2" }, { 23289, "WCショウス+2" }, { 23356, "WCサボ+2" },
            { 23089, "LTシャペル+2" }, { 23156, "LTサヨン+2" }, { 23223, "LTガントロ+2" }, { 23290, "LTフュゾー+2" }, { 23357, "LTウゾー+2" },
            { 23090, "SKボンネット+2" }, { 23157, "SKベスト+2" }, { 23224, "SKアムレット+2" }, { 23291, "SKキュロット+2" }, { 23358, "SKプーレーヌ+2" },
            { 23091, "CVアーメット+2" }, { 23158, "CVキュイラス+2" }, { 23225, "CVガントレ+2" }, { 23292, "CVクウィス+2" }, { 23359, "CVサバトン+2" },
            { 23092, "HTバゴネット+2" }, { 23159, "HTキュイラス+2" }, { 32226, "HTガントレト+2" }, { 23293, "HTフランチャ+2" }, { 23360, "HTソルレット+2" },
            { 23093, "NKカバセ+2" }, { 23160, "NKゴーザプ+2" }, { 23227, "NKマノプラス+2" }, { 23294, "NKキホーテ+2" }, { 23361, "NKオクレア+2" },
            { 32094, "FLキャロ+2" }, { 23161, "FLオングルリヌ+2" }, { 23228, "FLマンシェト+2" }, { 23295, "FLラングラヴ+2" }, { 23362, "FLコテュルヌ+2" },
            { 23095, "AMガペット+2" }, { 23162, "AMカバン+2" }, { 23229, "AMグロブレト+2" }, { 23296, "AMブラーグ+2" }, { 23363, "AMボティヨン+2" },
            { 23096, "真春日烏帽子形兜" }, { 23163, "真春日胴丸" }, { 23230, "真春日筒篭手" }, { 23297, "真春日板佩楯" }, { 23364, "真春日筒脛当" },
            { 23097, "真服部頭巾" }, { 23164, "真服部忍着" }, { 23231, "真服部手甲" }, { 23298, "真服部袴" }, { 23365, "真服部脚絆" },
            { 23098, "PEメザイユ+2" }, { 23165, "PEプラカート+2" }, { 23232, "PEバンブレス+2" }, { 23299, "PEキュイソー+2" }, { 23366, "PEシンバルド+2" },
            { 23099, "BCホーン+2" }, { 23166, "BCダブレット+2" }, { 23233, "BCブレーサー+2" }, { 23300, "BCスパッツ+2" }, { 23367, "BCピガッシュ+2" },
            { 23100, "HSカヴク+2" }, { 23167, "HSミンタン+2" }, { 23234, "HSバズバンド+2" }, { 23301, "HSタイト+2" }, { 23368, "HSバシュマク+2" },
            { 23101, "CSトリコルヌ+2" }, { 23168, "CSフラック+2" }, { 23235, "CSガントリー+2" }, { 23302, "CSトルーズ+2" }, { 23369, "CSブーツ+2" },
            { 23102, "KGカペッロ+2" }, { 23169, "KGファルセト+2" }, { 23236, "KGグアンティ+2" }, { 23303, "KGパンタロニ+2" }, { 23370, "KGスカルペ+2" },
            { 23103, "MCティアラ+2" }, { 23170, "MCカザク+2" }, { 23237, "MCバングル+2" }, { 23304, "MCタイツ+2" }, { 23371, "MCトーシュー+2" },
            { 23104, "ABボネット+2" }, { 23171, "ABガウン+2" }, { 23238, "ABブレーサー+2" }, { 23305, "ABパンツ+2" }, { 23372, "ABローファー+2" },
            { 23105, "AZフード+2" }, { 23172, "AZコート+2" }, { 23239, "AZグローブ+2" }, { 23306, "AZタイツ+2" }, { 23373, "AZゲートル+2" },
            { 23106, "ERガレア+2" }, { 23173, "ERサーコート+2" }, { 23240, "ERガントレ+2" }, { 23307, "ERレグガード+2" }, { 23374, "ERグリーヴ+2" }, };
        /// <summary>エンピ119+3</summary>
        internal Itm StorageSlip30 { get; } = new( 110 ) {  // 7-14
            { 23420, "BIマスク+3" }, { 23487, "BIロリカ+3" }, { 23554, "BIマフラ+3" }, { 23621, "BIクウィス+3" }, { 23688, "BIカリガ+3" },
            { 23421, "BKクラウン+3" }, { 23488, "BKシクラス+3" }, { 23555, "BKグローブ+3" }, { 23622, "BKホーズ+3" }, { 23689, "BKゲートル+3" },
            { 23422, "EBキャップ+3" }, { 23489, "EBブリオー+3" }, { 23556, "EBミトン+3" }, { 23623, "EBパンタロン+3" }, { 23690, "EBダックビル+3" },
            { 23423, "WCペタソス+3" }, { 23490, "WCコート+3" }, { 23557, "WCグローブ+3" }, { 23624, "WCショウス+3" }, { 23691, "WCサボ+3" },
            { 23424, "LTシャペル+3" }, { 23491, "LTサヨン+3" }, { 23558, "LTガントロ+3" }, { 23625, "LTフュゾー+3" }, { 23692, "LTウゾー+3" },
            { 23425, "SKボンネット+3" }, { 23492, "SKベスト+3" }, { 23559, "SKアムレット+3" }, { 23626, "SKキュロット+3" }, { 23693, "SKプーレーヌ+3" },
            { 23426, "CVアーメット+3" }, { 23493, "CVキュイラス+3" }, { 23560, "CVガントレ+3" }, { 23627, "CVクウィス+3" }, { 23694, "CVサバトン+3" },
            { 23427, "HTバゴネット+3" }, { 23494, "HTキュイラス+3" }, { 23561, "HTガントレト+3" }, { 23628, "HTフランチャ+3" }, { 23695, "HTソルレット+3" },
            { 23428, "NKカバセ+3" }, { 23495, "NKゴーザプ+3" }, { 23562, "NKマノプラス+3" }, { 23629, "NKキホーテ+3" }, { 23696, "NKオクレア+3" },
            { 23429, "FLキャロ+3" }, { 23496, "FLオングルリヌ+3" }, { 23563, "FLマンシェト+3" }, { 23630, "FLラングラヴ+3" }, { 23697, "FLコテュルヌ+3" },
            { 23430, "AMガペット+3" }, { 23497, "AMカバン+3" }, { 23564, "AMグロブレト+3" }, { 23631, "AMブラーグ+3" }, { 23698, "AMボティヨン+3" },
            { 23431, "極春日烏帽子形兜" }, { 23498, "極春日胴丸" }, { 23565, "極春日筒篭手" }, { 23632, "極春日板佩楯" }, { 23699, "極春日筒脛当" },
            { 23432, "極服部頭巾" }, { 23499, "極服部忍着" }, { 23566, "極服部手甲" }, { 23633, "極服部袴" }, { 23700, "極服部脚絆" },
            { 23433, "PEメザイユ+3" }, { 23500, "PEプラカート+3" }, { 23567, "PEバンブレス+3" }, { 23634, "PEキュイソー+3" }, { 23701, "PEシンバルド+3" },
            { 23434, "BCホーン+3" }, { 23501, "BCダブレット+3" }, { 23568, "BCブレーサー+3" }, { 23635, "BCスパッツ+3" }, { 23702, "BCピガッシュ+3" },
            { 23435, "HSカヴク+3" }, { 23502, "HSミンタン+3" }, { 23569, "HSバズバンド+3" }, { 23636, "HSタイト+3" }, { 23703, "HSバシュマク+3" },
            { 23436, "CSトリコルヌ+3" }, { 23503, "CSフラック+3" }, { 23570, "CSガントリー+3" }, { 23637, "CSトルーズ+3" }, { 23704, "CSブーツ+3" },
            { 23437, "KGカペッロ+3" }, { 23504, "KGファルセト+3" }, { 23571, "KGグアンティ+3" }, { 23638, "KGパンタロニ+3" }, { 23705, "KGスカルペ+3" },
            { 23438, "MCティアラ+3" }, { 23505, "MCカザク+3" }, { 23572, "MCバングル+3" }, { 23639, "MCタイツ+3" }, { 23706, "MCトーシュー+3" },
            { 23439, "ABボネット+3" }, { 23506, "ABガウン+3" }, { 23573, "ABブレーサー+3" }, { 23640, "ABパンツ+3" }, { 23707, "ABローファー+3" },
            { 23440, "AZフード+3" }, { 23507, "AZコート+3" }, { 23574, "AZグローブ+3" }, { 23641, "AZタイツ+3" }, { 23708, "AZゲートル+3" },
            { 23441, "ERガレア+3" }, { 23508, "ERサーコート+3" }, { 23575, "ERガントレ+3" }, { 23642, "ERレグガード+3" }, { 23709, "ERグリーヴ+3" }, };
        /// <summary>イベント報酬4</summary>
        internal Itm StorageSlip31 { get; } = new( 86 ) {   // 6-6
            { 23812, "サファイアマスク" }, { 23813, "サファイアプレート" }, { 23814, "サファイアガントレ" }, { 23815, "サファイアトラウザ" }, { 23816, "サファイアレギンス" },
            { 23817, "ジェダイドバイザー" }, { 23818, "ジェダイドクウィリ" }, { 23819, "ジェダイドグローブ" }, { 23820, "ジェダイドショウス" }, { 23821, "ジェダイドジャンボ" },
            { 23832, "ルビーコロナル" }, { 23833, "ルビーローブ" }, { 23834, "ルビーカフス" }, { 23835, "ルビースロップス" }, { 23836, "ルビーピガッシュ" },
            { 23822, "金剛総面" }, { 23823, "金剛腹巻" }, { 23824, "金剛篭手" }, { 23825, "金剛膝甲" }, { 23826, "金剛脛当" },
            { 23827, "エメラルドティアラ" }, { 23828, "エメラルドジュバ" }, { 23829, "エメラルドダスタナ" }, { 23830, "エメラルドシャルワ" }, { 23831, "エメラルドクラッコ" },
            { 23856, "アロゲンスクラウン" }, { 23857, "アロゲンスプレート" }, { 23858, "アロゲンスガントレ" }, { 23859, "アロゲンスブレー" }, { 23860, "アロゲンスサバトン" },
            { 23837, "アパシーマスク" }, { 23838, "アパシープレート" }, { 23839, "アパシーガントレ" }, { 23840, "アパシーブレー" }, { 23841, "アパシーサバトン" },
            { 23842, "レージプレート" }, { 23843, "レージガントレ" }, { 23844, "レージブレー" }, { 23845, "レージサバトン" },
            { 23846, "カワードペタソス" }, { 23847, "カワードコート" }, { 23848, "カワードグローブ" }, { 23849, "カワードトンバン" }, { 23850, "カワードサボ" },
            { 23851, "エンヴィクラウン" }, { 23852, "エンヴィシクラス" }, { 23853, "エンヴィガントレ" }, { 23854, "エンヴィフランチャ" }, { 23855, "エンヴィソルレット" },
            { 23894, "プリッシュブーツ" }, { 24271, "プリッシュブーツ+1" }, { 22003, "アースロセプター" },
            { 25674, "イルムティアラ" }, { 26521, "イルムウエスキット" }, { 25814, "イルムマニラ" }, { 25857, "イルムラッパ" }, { 25939, "イルムファラッシュ" },
            { 21520, "幽世の鉄拳" }, { 21571, "幽世の短剣" }, { 21624, "幽世の剣" }, { 21666, "幽世の大剣" }, { 21713, "幽世の戦斧" }, { 21771, "幽世の大斧" }, { 21838, "幽世の鎌" },
            { 21873, "幽世の槍" }, { 21911, "幽世の刀" }, { 21962, "幽世の太刀" }, { 22053, "幽世の棍" }, { 22090, "幽世の杖" }, { 22146, "幽世の強弓" }, { 22165, "幽世の長銃" },
            { 20655, "デュークソード" }, { 26417, "デュークシールド" }, { 24272, "朱雀帽子" }, { 3756, "ザッハトルテ" }, { 21950, "バドロッド" },
            { 24273, "崇武鳳凰兜" }, { 21874, "片鎌槍" }, { 21949, "シェードモグロッド" }, { 21951, "シェードモグロッド+1" },
            { 20656, "ジャジャソード" }, { 21542, "ジャジャメイス" }, { 26418, "サボテンダーの盾" }, { 21543, "涼風団扇" }, { 10863, "奈落の仮面" }, { 18567, "コリブリサイズ" }, };
        /// <summary>AF119+4</summary>
        internal Itm StorageSlip32 { get; } = new( 115 ) {  // 8-3
            { 23895, "PMマスク+4" }, { 23940, "PMロリカ+4" }, { 23985, "PMマフラ+4" }, { 24030, "PMクウィス+4" }, { 24075, "PMカリガ+4" },
            { 23896, "ANクラウン+4" }, { 23941, "ANシクラス+4" }, { 23986, "ANグローブ+4" }, { 24031, "ANホーズ+4" }, { 24076, "ANゲートル+4" },
            { 23897, "TEキャップ+4" }, { 23942, "TEブリオー+4" }, { 23987, "TEミトン+4" }, { 24032, "TEパンタロン+4" }, { 24077, "TEダックビル+4" },
            { 23898, "SPペタソス+4" }, { 23943, "SPコート+4" }, { 23988, "SPグローブ+4" }, { 24033, "SPトンバン+4" }, { 24078, "SPサボ+4" },
            { 23899, "ATシャポー+4" }, { 23944, "ATタバード+4" }, { 23989, "ATグローブ+4" }, { 24034, "ATタイツ+4" }, { 24079, "ATブーツ+4" },
            { 23900, "PLボンネット+4" }, { 23945, "PLベスト+4" }, { 23990, "PLアムレット+4" }, { 24035, "PLキュロット+4" }, { 24080, "PLプーレーヌ+4" },
            { 23901, "RVコロネット+4" }, { 23946, "RVサーコート+4" }, { 23991, "RVガントレ+4" }, { 24036, "RVブリーチズ+4" }, { 24081, "RVレギンス+4" },
            { 23902, "IGバゴネット+4" }, { 23947, "IGキュイラス+4" }, { 23992, "IGガントレ+4" }, { 24037, "IGフランチャ+4" }, { 24082, "IGソルレット+4" },
            { 23903, "TOヘルム+4" }, { 23948, "TOジャック+4" }, { 23993, "TOグローブ+4" }, { 24038, "TOトラウザ+4" }, { 24083, "TOゲートル+4" },
            { 23904, "BRランドリト+4" }, { 23949, "BRジュスト+4" }, { 23994, "BRカフス+4" }, { 24039, "BRキャニオン+4" }, { 24084, "BRスリッパー+4" },
            { 23905, "ORベレー+4" }, { 23950, "ORジャーキン+4" }, { 23995, "ORブレーサー+4" }, { 24040, "ORブラッカエ+4" }, { 24085, "ORソックス+4" },
            { 23906, "越脇戸桃形兜" }, { 23951, "越脇戸胴丸" }, { 23996, "越脇戸筒篭手" }, { 24041, "越脇戸板佩楯" }, { 24086, "越脇戸筒脛当" },
            { 23907, "越蜂屋半首" }, { 23952, "越蜂屋鎖帷子" }, { 23997, "越蜂屋手甲" }, { 24042, "越蜂屋袴" }, { 24087, "越蜂屋脚絆" },
            { 23908, "VSアーメット+4" }, { 23953, "VSメイル+4" }, { 23998, "VSフィンガー+4" }, { 24043, "VSブレー+4" }, { 24088, "VSグリーヴ+4" },
            { 23909, "CNホーン+4" }, { 23954, "CNダブレット+4" }, { 23999, "CNブレーサー+4" }, { 24044, "CNスパッツ+4" }, { 24089, "CNピガッシュ+4" },
            { 23910, "ASケフィエ+4" }, { 23955, "ASジュバ+4" }, { 24000, "ASバズバンド+4" }, { 24045, "ASシャルワー+4" }, { 24090, "ASチャルク+4" },
            { 23911, "LKトリコルヌ+4" }, { 23956, "LKフラック+4" }, { 24001, "LKガントリー+4" }, { 24046, "LKトルーズ+4" }, { 24091, "LKブーツ+4" },
            { 23912, "FOタージ+4" }, { 23957, "FOトベ+4" }, { 24002, "FOダスタナ+4" }, { 24047, "FOチュリダル+4" }, { 24092, "FOバブーシュ+4" },
            { 23913, "MXティアラ+4♂" }, { 23958, "MXカザク+4♂" }, { 24003, "MXバングル+4♂" }, { 24048, "MXタイツ+4♂" }, { 24093, "MXトーシュー+4♂" },
            { 23914, "MXティアラ+4♀" }, { 23959, "MXカザク+4♀" }, { 24004, "MXバングル+4♀" }, { 24049, "MXタイツ+4♀" }, { 24094, "MXトーシュー+4♀" },
            { 23915, "ACボード+4" }, { 23960, "ACガウン+4" }, { 24005, "ACブレーサー+4" }, { 24050, "ACパンツ+4" }, { 24095, "ACローファー+4" },
            { 23916, "GOガレーロ+4" }, { 23961, "GOチュニック+4" }, { 24006, "GOミテーヌ+4" }, { 24051, "GOパンツ+4" }, { 24096, "GOサンダル+4" },
            { 23917, "RNバンド+4" }, { 23962, "RNコート+4" }, { 24007, "RNミトン+4" }, { 24052, "RNトラウザ+4" }, { 24097, "RNブーツ+4" } };
        /// <summary>レリック119+4</summary>
        internal Itm StorageSlip33 { get; } = new( 110 ) {  // 7-14
            { 23918, "AGマスク+4" }, { 23963, "AGロリカ+4" }, { 24008, "AGマフラ+4" }, { 24053, "AGクウィス+4" }, { 24098, "AGカリガ+4" },
            { 23919, "HEクラウン+4" }, { 23964, "HEシクラス+4" }, { 24009, "HEグローブ+4" }, { 24054, "HEホーズ+4" }, { 24099, "HEゲートル+4" },
            { 23920, "PIキャップ+4" }, { 23965, "PIブリオー+4" }, { 24010, "PIミトン+4" }, { 24055, "PIパンタロン+4" }, { 24100, "PIダックビル+4" },
            { 23921, "ARペタソス+4" }, { 23966, "ARコート+4" }, { 24011, "ARグローブ+4" }, { 24056, "ARトンバン+4" }, { 24101, "ARサボ+4" },
            { 23922, "VIシャポー+4" }, { 23967, "VIタバード+4" }, { 24012, "VIグローブ+4" }, { 24057, "VIタイツ+4" }, { 24102, "VIブーツ+4" },
            { 23923, "PDボンネット+4" }, { 23968, "PDベスト+4" }, { 24013, "PDアムレット+4" }, { 24058, "PDキュロット+4" }, { 24103, "PDプーレーヌ+4" },
            { 23924, "CBコロネット+4" }, { 23969, "CBサーコート+4" }, { 24014, "CBガントレ+4" }, { 24059, "CBブリーチズ+4" }, { 24104, "CBレギンス+4" },
            { 23925, "FLバーゴネット+4" }, { 23970, "FLキュイラス+4" }, { 24015, "FLガントレット+4" }, { 24060, "FLフランチャー+4" }, { 24105, "FLソルレット+4" },
            { 23926, "AKヘルム+4" }, { 23971, "AKジャック+4" }, { 24016, "AKグローブ+4" }, { 24061, "AKトラウザ+4" }, { 24106, "AKゲートル+4" },
            { 23927, "BIラウンドリト+4" }, { 23972, "BIジュストコル+4" }, { 24017, "BIカフス+4" }, { 24062, "BIキャニオンズ+4" }, { 24107, "BIスリッパー+4" },
            { 23928, "ARベレー+4" }, { 23973, "ARジャーキン+4" }, { 24018, "ARブレーサー+4" }, { 24063, "ARブラッカエ+4" }, { 24108, "ARソックス+4" },
            { 23929, "越左近士桃形兜" }, { 23974, "越左近士胴丸" }, { 24019, "越左近士筒篭手" }, { 24064, "越左近士板佩楯" }, { 24109, "越左近士筒脛当" },
            { 23930, "越望月半首" }, { 23975, "越望月鎖帷子" }, { 24020, "越望月手甲" }, { 24065, "越望月袴" }, { 24110, "越望月脚絆" },
            { 23931, "PTアーメット+4" }, { 23976, "PTメイル+4" }, { 24021, "PTフィンガー+4" }, { 24066, "PTブレー+4" }, { 24111, "PTグリーヴ+4" },
            { 23932, "GLホーン+4" }, { 23977, "GLダブレット+4" }, { 24022, "GLブレーサー+4" }, { 24067, "GLスパッツ+4" }, { 24112, "GLピガッシュ+4" },
            { 23933, "LLケフィエ+4" }, { 23978, "LLジュバ+4" }, { 24023, "LLバズバンド+4" }, { 24068, "LLシャルワー+4" }, { 24113, "LLチャルク+4" },
            { 23934, "LAトリコルヌ+4" }, { 23979, "LAフラック+4" }, { 24024, "LAガントリー+4" }, { 24069, "LAトルーズ+4" }, { 24114, "LAブーツ+4" },
            { 23935, "PIタージ+4" }, { 23980, "PIトベ+4" }, { 24025, "PIダスタナ+4" }, { 24070, "PIチュリダル+4" }, { 24115, "PIバブーシュ+4" },
            { 23936, "HOティアラ+4" }, { 23981, "HOカザク+4" }, { 24026, "HOバングル+4" }, { 24071, "HOタイツ+4" }, { 24116, "HOトーシュー+4" },
            { 23937, "PDボード+4" }, { 23982, "PDガウン+4" }, { 24027, "PDブレーサー+4" }, { 24072, "PDパンツ+4" }, { 24117, "PDローファー+4" },
            { 23938, "BAガレーロ+4" }, { 23983, "BAチュニック+4" }, { 24028, "BAミテーヌ+4" }, { 24073, "BAパンツ+4" }, { 24118, "BAサンダル+4" },
            { 23939, "FUバンド+4" }, { 23984, "FUコート+4" }, { 24029, "FUミトン+4" }, { 24074, "FUトラウザ+4" }, { 24119, "FUブーツ+4" } };
        #endregion
